...
public class TextInfoServiceImpl implements ITextInfoService { 
	...
	public void delTextInfo(
		...
		try {
			...
			logger.debug("delTextInfo(DelTextInfo) - end - return"); 
		}catch (TsfaServiceException e) {
			logger.error(e.getMessage(),e);
			throw e;
		}  catch (Exception e) {
	...
	public void updateTextInfo(
		...
		logger.debug("updateTextInfo(UpdateTextInfo updateTextInfo={}) - start", updateTextInfo); 
		...
		try {
			...
			logger.debug("updateTextInfo(UpdateTextInfo) - end - return"); 
		}catch (TsfaServiceException e) {
			logger.error(e.getMessage(),e);
			throw e;
		} catch (Exception e) {
	...
	public FindTextInfoReturn findTextInfo(
		...
		logger.debug("findTextInfo(FindTextInfo findTextInfo={}) - start", findTextInfo); 
		...
		try {
			...
			logger.debug("findTextInfo(FindTextInfo) - end - return value={}", findTextInfoReturn); 
	...
	public Page<FindTextInfoPageReturn> findTextInfoPage(
			...
			throws TsfaServiceException {
		logger.debug("findTextInfoPage(FindTextInfoPage findTextInfoPage={}) - start", findTextInfoPage); 
		...
		logger.debug("findTextInfoPage(FindTextInfoPage) - end - return value={}", returnPage); 
		return  returnPage;
	}
