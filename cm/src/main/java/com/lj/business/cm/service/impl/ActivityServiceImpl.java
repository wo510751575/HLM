...
public class ActivityServiceImpl implements IActivityService { 
	...
	public AddActivityReturn addActivity(
		...
		try {
			...
			//add数据录入
			activity.setCode(addActivity.getCode());
			...
			addActivityReturn.setCode(activity.getCode());
	...
	public DelActivityReturn delActivity(
		...
		try {
			...
			logger.debug("delActivity(DelActivity) - end - return value={}", delActivityReturn); 
	...
	public UpdateActivityReturn updateActivity(
		...
		logger.debug("updateActivity(UpdateActivity updateActivity={}) - start", updateActivity); 
		...
		try {
			...
			logger.debug("updateActivity(UpdateActivity) - end - return value={}", updateActivityReturn); 
	...
	public FindActivityReturn findActivity(
		...
		logger.debug("findActivity(FindActivity findActivity={}) - start", findActivity); 
		...
		try {
			...
			logger.debug("findActivity(FindActivity) - end - return value={}", findActivityReturn); 
	...
	public Page<FindActivityPageReturn> findActivityPage(
			...
			throws TsfaServiceException {
		logger.debug("findActivityPage(FindActivityPage findActivityPage={}) - start", findActivityPage); 
		...
		logger.debug("findActivityPage(FindActivityPage) - end - return value={}", returnPage); 
		return  returnPage;
	}
	...
	public List<FindActivityPageReturn> findActivitys(FindActivityPage findActivityPage) throws TsfaServiceException {
		logger.debug("findActivitys(FindActivityPage findActivityPage={}) - start", findActivityPage); 
		AssertUtils.notNull(findActivityPage);
		List<FindActivityPageReturn> returnList;
		try {
		...
		logger.debug("findActivityDto(findActivityDto) - end - return value={}", returnList); 
		return returnList;
	}
	...
	public void addActivityForShare(UpdateActivity updateActivity)
			throws TsfaServiceException {
		logger.debug("addActivityForShare(UpdateActivity updateActivity={}) - start", updateActivity); 
		AssertUtils.notNull(updateActivity);
