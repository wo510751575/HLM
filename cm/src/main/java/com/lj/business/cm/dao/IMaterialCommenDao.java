...
public interface IMaterialCommenDao {
	 ...
	 * @author 
	 */
	List<FindMaterialTypePageReturn> findCommonMaterialTypePage(FindMaterialTypePage findMaterialTypePage);
	/**
	 *@Desc 
	 *@param updateMaterial
	 *@return void
	 *@author 贾光朝
	 *@createDate 2019年6月10日下午5:38:26
	 */
	void updateTypeName(UpdateMaterial updateMaterial);
}