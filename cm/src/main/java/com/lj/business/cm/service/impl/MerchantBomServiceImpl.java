...
public class MerchantBomServiceImpl implements IMerchantBomService { 
	...
	public DelMerchantBomReturn delMerchantBom(
		...
		try {
			...
			logger.debug("delMerchantBom(DelMerchantBom) - end - return value={}", delMerchantBomReturn); 
	...
	public UpdateMerchantBomReturn updateMerchantBom(
		...
		logger.debug("updateMerchantBom(UpdateMerchantBom updateMerchantBom={}) - start", updateMerchantBom); 
		...
		try {
			...
			logger.debug("updateMerchantBom(UpdateMerchantBom) - end - return value={}", updateMerchantBomReturn); 
	...
	public FindMerchantBomReturn findMerchantBom(
		...
		logger.debug("findMerchantBom(FindMerchantBom findMerchantBom={}) - start", findMerchantBom); 
		...
		try {
			...
			logger.debug("findMerchantBom(FindMerchantBom) - end - return value={}", findMerchantBomReturn); 
	...
	public Page<FindMerchantBomPageReturn> findMerchantBomPage(
			...
			throws TsfaServiceException {
		logger.debug("findMerchantBomPage(FindMerchantBomPage findMerchantBomPage={}) - start", findMerchantBomPage); 
		...
		logger.debug("findMerchantBomPage(FindMerchantBomPage) - end - return value={}", returnPage); 
		return  returnPage;
	} 
