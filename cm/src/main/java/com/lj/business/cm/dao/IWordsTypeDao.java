...
public interface IWordsTypeDao {
    ...
    int updateByPrimaryKeySelective(WordsType code);
	 ...
	 *
	 */
	int hasTypeName(@Param("memberNoGm")String memberNoGm,@Param("typeName")String typeName);
	 ...
	 *
	 */
	int hasSeq(@Param("memberNoGm")String memberNoGm,@Param("seq")Integer seq);
	 ...
	 *
	 */
	List<FindWordsAppReturn> findPersonWords(FindWordsTypePage findWordsTypePage);
