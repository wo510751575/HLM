...
public class MaterialServiceImplTest extends SpringTestCase{
	...
	public void findMaterialAppPage() throws TsfaServiceException{
		...
		findMaterialAppPage.setMerchantNo("96f4d5ddad504998af92bbfda6dd4153");
		findMaterialAppPage.setMemberNoGm("41af1ac05a0e42cb8b8bdcbe0dda019b");
		findMaterialAppPage.setMaterialTypeCode("LJ_4050c2cd10084cea8d57d0ed6050d7ce");
//		findMaterialAppPage.setShopNo("LJ_3caf0aa07e2e4f2f9d7885b75100c694");
	...
	@Test
	public void addMaterialEc() throws TsfaServiceException {
			AddMaterial addMaterial = new AddMaterial();
			// add数据录入
			addMaterial.setCode(GUID.getPreUUID());
			addMaterial.setMerchantNo("e79d975846ee41ba8c3c55738fda66a9");
			...
			Assert.assertNotNull(materialService.addMaterialEc(addMaterial));
	}
