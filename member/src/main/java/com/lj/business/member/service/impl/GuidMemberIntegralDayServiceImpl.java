...
//			guidMemberIntegralDay.setShopName(addGuidMemberIntegralDay.getShopName());
	...
	public void delGuidMemberIntegralDay(
		...
		try {
			...
			logger.debug("delGuidMemberIntegralDay(DelGuidMemberIntegralDay) - end - return"); 
		}catch (TsfaServiceException e) {
			logger.error(e.getMessage(),e);
			throw e;
		}  catch (Exception e) {
	...
	public void updateGuidMemberIntegralDay(
		...
		logger.debug("updateGuidMemberIntegralDay(UpdateGuidMemberIntegralDay updateGuidMemberIntegralDay={}) - start", updateGuidMemberIntegralDay); 
...
//			guidMemberIntegralDay.setShopName(updateGuidMemberIntegralDay.getShopName());
			...
			logger.debug("updateGuidMemberIntegralDay(UpdateGuidMemberIntegralDay) - end - return"); 
		}catch (TsfaServiceException e) {
			logger.error(e.getMessage(),e);
			throw e;
		} catch (Exception e) {
	...
	public FindGuidMemberIntegralDayReturn findGuidMemberIntegralDay(
		...
		logger.debug("findGuidMemberIntegralDay(FindGuidMemberIntegralDay findGuidMemberIntegralDay={}) - start", findGuidMemberIntegralDay); 
...
//			findGuidMemberIntegralDayReturn.setShopName(guidMemberIntegralDay.getShopName());
			...
			logger.debug("findGuidMemberIntegralDay(FindGuidMemberIntegralDay) - end - return value={}", findGuidMemberIntegralDayReturn); 
