...
public class BehaviorPmServiceImpl implements IBehaviorPmService { 
	...
	public void delBehaviorPm(
		...
		try {
			...
			logger.debug("delBehaviorPm(DelBehaviorPm) - end - return"); 
		}catch (TsfaServiceException e) {
			logger.error(e.getMessage(),e);
			throw e;
		}  catch (Exception e) {
	...
	public void updateBehaviorPm(
		...
		logger.debug("updateBehaviorPm(UpdateBehaviorPm updateBehaviorPm={}) - start", updateBehaviorPm); 
		...
		try {
			...
			logger.debug("updateBehaviorPm(UpdateBehaviorPm) - end - return"); 
		}catch (TsfaServiceException e) {
			logger.error(e.getMessage(),e);
			throw e;
		} catch (Exception e) {
	...
	public FindBehaviorPmReturn findBehaviorPm(
		...
		logger.debug("findBehaviorPm(FindBehaviorPm findBehaviorPm={}) - start", findBehaviorPm); 
		...
		try {
			...
			logger.debug("findBehaviorPm(FindBehaviorPm) - end - return value={}", findBehaviorPmReturn); 
	...
	public Page<FindBehaviorPmPageReturn> findBehaviorPmPage(
			...
			throws TsfaServiceException {
		logger.debug("findBehaviorPmPage(FindBehaviorPmPage findBehaviorPmPage={}) - start", findBehaviorPmPage); 
		...
		logger.debug("findBehaviorPmPage(FindBehaviorPmPage) - end - return value={}", returnPage); 
		return  returnPage;
	} 
