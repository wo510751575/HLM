...
public class BehaviorInfoPmServiceImpl implements IBehaviorInfoPmService { 
	...
	public void delBehaviorInfoPm(
		...
		try {
			...
			logger.debug("delBehaviorInfoPm(DelBehaviorInfoPm) - end - return"); 
		}catch (TsfaServiceException e) {
			logger.error(e.getMessage(),e);
			throw e;
		}  catch (Exception e) {
	...
	public void updateBehaviorInfoPm(
		...
		logger.debug("updateBehaviorInfoPm(UpdateBehaviorInfoPm updateBehaviorInfoPm={}) - start", updateBehaviorInfoPm); 
		...
		try {
			...
			logger.debug("updateBehaviorInfoPm(UpdateBehaviorInfoPm) - end - return"); 
		}catch (TsfaServiceException e) {
			logger.error(e.getMessage(),e);
			throw e;
		} catch (Exception e) {
	...
	public FindBehaviorInfoPmReturn findBehaviorInfoPm(
		...
		logger.debug("findBehaviorInfoPm(FindBehaviorInfoPm findBehaviorInfoPm={}) - start", findBehaviorInfoPm); 
		...
		try {
			...
			logger.debug("findBehaviorInfoPm(FindBehaviorInfoPm) - end - return value={}", findBehaviorInfoPmReturn); 
	...
	public Page<FindBehaviorInfoPmPageReturn> findBehaviorInfoPmPage(
			...
			throws TsfaServiceException {
		logger.debug("findBehaviorInfoPmPage(FindBehaviorInfoPmPage findBehaviorInfoPmPage={}) - start", findBehaviorInfoPmPage); 
		...
		logger.debug("findBehaviorInfoPmPage(FindBehaviorInfoPmPage) - end - return value={}", returnPage); 
		return  returnPage;
	} 
