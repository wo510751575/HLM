...
//			guidMemberIntegral.setShopName(addGuidMemberIntegral.getShopName());
	...
	public void delGuidMemberIntegral(
		...
		try {
			...
			logger.debug("delGuidMemberIntegral(DelGuidMemberIntegral) - end - return"); 
		}catch (TsfaServiceException e) {
			logger.error(e.getMessage(),e);
			throw e;
		}  catch (Exception e) {
	...
	public void updateGuidMemberIntegral(
		...
		logger.debug("updateGuidMemberIntegral(UpdateGuidMemberIntegral updateGuidMemberIntegral={}) - start", updateGuidMemberIntegral); 
...
//			guidMemberIntegral.setShopName(updateGuidMemberIntegral.getShopName());
			...
			logger.debug("updateGuidMemberIntegral(UpdateGuidMemberIntegral) - end - return"); 
		}catch (TsfaServiceException e) {
			logger.error(e.getMessage(),e);
			throw e;
		} catch (Exception e) {
	...
	public FindGuidMemberIntegralReturn findGuidMemberIntegral(
		...
		logger.debug("findGuidMemberIntegral(FindGuidMemberIntegral findGuidMemberIntegral={}) - start", findGuidMemberIntegral); 
...
//			findGuidMemberIntegralReturn.setShopName(guidMemberIntegral.getShopName());
			...
			logger.debug("findGuidMemberIntegral(FindGuidMemberIntegral) - end - return value={}", findGuidMemberIntegralReturn); 
...
//					guidMemberIntegralDto.setShopName(guidMemberReturnDto.getShopName());
			...
			if(StringUtils.isEmpty(guidMemberIntegralDto.getAreaName())){
				String areaName = areaHessianService.getAreaNameByCode(guidMemberIntegralDto.getAreaCode());
				guidMemberIntegralDto.setAreaName(areaName);
			}
