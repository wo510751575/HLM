...
public class CustKeepServiceImpl implements ICustKeepService { 
	...
	public void delCustKeep(
		...
		try {
			...
			logger.debug("delCustKeep(DelCustKeep) - end - return"); 
		}catch (TsfaServiceException e) {
			logger.error(e.getMessage(),e);
			throw e;
		}  catch (Exception e) {
	...
	public FindCustKeepReturn findCustKeep(
		...
		logger.debug("findCustKeep(FindCustKeep findCustKeep={}) - start", findCustKeep); 
		...
		try {
			...
			logger.debug("findCustKeep(FindCustKeep) - end - return value={}", findCustKeepReturn); 
	...
	public Page<FindCustKeepPageReturn> findCustKeepPage(
		...
		logger.debug("findCustKeepPage(FindCustKeepPage findCustKeepPage={}) - start", findCustKeepPage); 
		...
		logger.debug("findCustKeepPage(FindCustKeepPage) - end - return value={}", returnPage); 
		return  returnPage;
	}
