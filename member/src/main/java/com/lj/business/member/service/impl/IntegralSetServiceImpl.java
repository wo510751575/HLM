...
//			integralSet.setShopName(addIntegralSet.getShopName());
	...
	public void delIntegralSet(
		...
		try {
			...
			logger.debug("delIntegralSet(DelIntegralSet) - end - return"); 
		}catch (TsfaServiceException e) {
			logger.error(e.getMessage(),e);
			throw e;
		}  catch (Exception e) {
	...
	public void updateIntegralSet(
		...
		logger.debug("updateIntegralSet(UpdateIntegralSet updateIntegralSet={}) - start", updateIntegralSet); 
...
//			integralSet.setShopName(updateIntegralSet.getShopName());
			...
			logger.debug("updateIntegralSet(UpdateIntegralSet) - end - return"); 
		}catch (TsfaServiceException e) {
			logger.error(e.getMessage(),e);
			throw e;
		} catch (Exception e) {
	...
	public FindIntegralSetReturn findIntegralSet(
		...
		logger.debug("findIntegralSet(FindIntegralSet findIntegralSet={}) - start", findIntegralSet); 
...
//			findIntegralSetReturn.setShopName(integralSet.getShopName());
			...
			logger.debug("findIntegralSet(FindIntegralSet) - end - return value={}", findIntegralSetReturn); 
