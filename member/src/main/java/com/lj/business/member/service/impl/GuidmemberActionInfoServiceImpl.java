...
//			guidmemberActionInfo.setShopName(addGuidmemberActionInfo.getShopName());
	...
	public void delGuidmemberActionInfo(
		...
		try {
			...
			logger.debug("delGuidmemberActionInfo(DelGuidmemberActionInfo) - end - return"); 
		}catch (TsfaServiceException e) {
			logger.error(e.getMessage(),e);
			throw e;
		}  catch (Exception e) {
	...
	public void updateGuidmemberActionInfo(
		...
		logger.debug("updateGuidmemberActionInfo(UpdateGuidmemberActionInfo updateGuidmemberActionInfo={}) - start", updateGuidmemberActionInfo); 
...
//			guidmemberActionInfo.setShopName(updateGuidmemberActionInfo.getShopName());
			...
			logger.debug("updateGuidmemberActionInfo(UpdateGuidmemberActionInfo) - end - return"); 
		}catch (TsfaServiceException e) {
			logger.error(e.getMessage(),e);
			throw e;
		} catch (Exception e) {
	...
	public FindGuidmemberActionInfoReturn findGuidmemberActionInfo(
		...
		logger.debug("findGuidmemberActionInfo(FindGuidmemberActionInfo findGuidmemberActionInfo={}) - start", findGuidmemberActionInfo); 
...
//			findGuidmemberActionInfoReturn.setShopName(guidmemberActionInfo.getShopName());
			...
			logger.debug("findGuidmemberActionInfo(FindGuidmemberActionInfo) - end - return value={}", findGuidmemberActionInfoReturn); 
	...
	public List<FindGuidmemberActionInfoReturn> findGuidmemberActionInfoList(FindGuidmemberActionInfoListDto findGuidmemberActionInfoListDto) throws TsfaServiceException {
		logger.debug("findGuidmemberActionInfoList(FindGuidmemberActionInfoListDto findGuidmemberActionInfoListDto={}) - start", findGuidmemberActionInfoListDto); 
		...
		try{
			...
			logger.debug("findGuidmemberActionInfoList() - end - return value={}", list); 
			return list;
		}catch (TsfaServiceException e) {
			logger.error(e.getMessage(),e);
			throw e;
