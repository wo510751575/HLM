...
public class LoginCheckServiceImpl implements ILoginCheckService { 
	...
	public DelLoginCheckReturn delLoginCheck(
		...
		try {
			...
			logger.debug("delLoginCheck(DelLoginCheck) - end - return value={}", delLoginCheckReturn); 
	...
	public UpdateLoginCheckReturn updateLoginCheck(
		...
		logger.debug("updateLoginCheck(UpdateLoginCheck updateLoginCheck={}) - start", updateLoginCheck); 
		...
		try {
			...
			logger.debug("updateLoginCheck(UpdateLoginCheck) - end - return value={}", updateLoginCheckReturn); 
	...
	public FindLoginCheckReturn findLoginCheck(
		...
		logger.debug("findLoginCheck(FindLoginCheck findLoginCheck={}) - start", findLoginCheck); 
		...
		try {
			...
			logger.debug("findLoginCheck(FindLoginCheck) - end - return value={}", findLoginCheckReturn); 
	...
	public Page<FindLoginCheckPageReturn> findLoginCheckPage(
			...
			throws TsfaServiceException {
		logger.debug("findLoginCheckPage(FindLoginCheckPage findLoginCheckPage={}) - start", findLoginCheckPage); 
		...
		logger.debug("findLoginCheckPage(FindLoginCheckPage) - end - return value={}", returnPage); 
		return  returnPage;
	}
