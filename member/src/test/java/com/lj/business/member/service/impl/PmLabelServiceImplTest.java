...
//		System.out.println(list.toString());
	...
	public void addPmLabelPm() throws TsfaServiceException{
		...
		record.setPmLabelName("pmLabelName");
		pmLabelPmDao.insertOrUpdate(record);
	}
	...
	@Test
	public void findPmLabelByMerchantNoAndShopWx() throws TsfaServiceException{
		Map<String,String> parmap = new HashMap<String, String>();
		parmap.put("merchantNo", "e96f64d736564a768c9ab9f23f4962df");
		parmap.put("shopWx", "wxid_klh1bsjjjg3e22");
	   List<Map<String,String>>	list=pmLabelService.findPmLabelByMerchantNoAndShopWx(parmap);
	 System.out.println(list.toString());
	}
}
