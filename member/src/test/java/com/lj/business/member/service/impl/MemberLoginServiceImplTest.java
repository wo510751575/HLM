...
public class MemberLoginServiceImplTest extends SpringTestCase{
	...
	public void loginApp() throws TsfaServiceException{
		...
		personMemberLogin.setMobile("18922898746");
		personMemberLogin.setPwd("1cc77187e75f2040e9a5e382cf28e0df");
...
//		updatePwdDto.setPwd(MD5.encryptByMD5("435143"));
	...
	public void login() throws Exception {
		...
		decrpytDTO.setEncryptorId("3");
		decrpytDTO.setInputText("b28f1c7b013c32d1f12437718f387d85");
		DecryptResponse decrypt = encryptorService.decrypt(decrpytDTO);
		System.out.println(decrypt.getOutputText());
	}
