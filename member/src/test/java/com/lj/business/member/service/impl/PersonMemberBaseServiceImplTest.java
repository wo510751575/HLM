...
public class PersonMemberBaseServiceImplTest extends SpringTestCase{
	...
	public void addPersonMemberBase() throws TsfaServiceException{
		...
		addPersonMemberBase.setNoWw("ww123");
	...
	public void findPersonMemberBase() throws TsfaServiceException{
		...
		findPersonMemberBase.setCode("LJ_bbb78639d803435fb094890c16ac83c4");
		FindPersonMemberBaseReturn data=personMemberBaseService.findPersonMemberBase(findPersonMemberBase);
...
//		findPersonMemberBasePage.setPmTypeCode("1");
   ...
   @Test
   public void findPersonMemberNum(){
	   FindPersonMemberBaseList baseList=new FindPersonMemberBaseList();
	   baseList.setMerchantNo("2169d1820e254e86b110dff73e1bd58f");
	   baseList.setStartTime(DateUtils.addDays(new Date(), -30));
	   baseList.setEndTime(new Date());
	   FindPersonMemberBaseReturnList list= personMemberBaseService.findPersonMemberBaseNums(baseList);
	   System.out.println(list);
  }
   
   @Test
   public void testFindMemberBaseByNoWxOrAlias() {
//	   personMemberBaseService.findMemberBaseByNoWxOrAlias("wxid_ebl39k3xvh3l22", "ljkj3437");
	   personMemberBaseService.findMemberBaseByNoWxOrAlias(null, "ljkj3437");
   }
}
