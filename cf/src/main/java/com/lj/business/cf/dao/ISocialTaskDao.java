...
public interface ISocialTaskDao {
	...
	List<SocialTask> selectByParams(SocialTask socialTask);
	 ...
	 *
	 */
	List<Map<String, Object>> findSocialTaskProduce(Map<String, Object> map);
	 ...
	 *
	 */
	List<Map<String, Object>> findSocialTaskFinish(Map<String, Object> map);
}