...
public interface IComTaskDao {
	 ...
	 *
	 */
	int closeGroup(CloseGroup closeGroup);
	 ...
	 *
	 */
	List<Map<String, Object>> findComTaskProduceByShop(Map<String, Object> map);
	 ...
	 *
	 */
	List<Map<String, Object>> findComTaskFinish(Map<String, Object> map);
	 ...
	 *
	 */
	FindComTaskReturn findLastRecordByMGM(FindComTask findComTask);
	
	/**
	 * 
	 *
	 * 方法说明：获取FINISH等于初次介绍的客户
	 *
	 * @param findComTask
	 * @return
	 *
	 ...
	 *
	 */
	List<FindComTaskReturn> queryComTaskFinish(FindComTask findComTask);
	 ...
	 *
	 */
	List<FindLastComTaskReturn> findLastRecordByGm(FindComTask findComTask);
