...
public class PmAbandonServiceImpl implements IPmAbandonService { 
	...
	@Override
	public void updateRejectByGm(UpdatePmAbandon updatePmAbandon) {
		logger.debug("updateRejectByGm(UpdatePmAbandon updatePmAbandon={}) - start", updatePmAbandon);
		AssertUtils.notNullAndEmpty(updatePmAbandon.getMemberNoGm(), "导购编号不能为空");
		pmAbandonDao.updateRejectByGm(updatePmAbandon);
	}	
