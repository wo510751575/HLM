...
public class CfErrorInfoServiceImpl implements ICfErrorInfoService { 
	...
	public void addCfErrorInfo(AddCfErrorInfoDto addCfErrorInfoDto) {
		logger.debug("addCfErrorInfo(AddCfErrorInfoDto addCfErrorInfoDto={}) - start", addCfErrorInfoDto); //$NON-NLS-1$
		...
		logger.debug("addCfErrorInfo(AddCfErrorInfoDto) - end"); //$NON-NLS-1$
	}
