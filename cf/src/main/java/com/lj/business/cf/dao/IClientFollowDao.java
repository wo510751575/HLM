...
public interface IClientFollowDao {
     ...
     *
     */
	Integer findSumFollowShop(Map<String, Object> map);
	 ...
	 *
	 */
	ClientFollow findClientFollowSelect(FindClientFollow findClientFollow);
	 ...
	 *
	 */
	Long findCountNumPmCfDayByGm(Map<String, Object> map);
	 ...
	 *
	 */
	Long findCountNumCfDayByGm(Map<String, Object> map);
	 ...
	 *
	 */
	List<Map<String, Object>> getClientFollowInfo(Map<String, Object> map);
}