...
/*	@Test
	...
	*/
	 ...
	 */
	@Test
	public void addCFRecord() throws TsfaServiceException, ParseException{
		//AddClientFollow [merchantNo=1f169ad6143d46f5832535642ce2d331,
//cfNo=null, memberNo=adc5e91c44a5466d9ed92f9c5aa998b3,
//memberName=null, memberNoGm=be077339bcad4049b7ddfe9db7aed6ae, memberNameGm=null, followNum=null,
//followType=SYSTEM, followInfo=初次介绍, deal=null, status=null, orderAmount=null,
//nextDate=Mon Sep 11 18:12:38 CST 2017, taskCode=LJ_5c0351c816e2453aaf712509fdca87c6, taskName=null,
//notDealReason=null, resean=null, comTaskType=INVITE, comTaskTypeCf=FIRST_INTR, clientExpNum=null, clientInviteNum=null,
//clientGuidNum=null, remark=null, createId=null, remark4=null, remark3=null, remark2=null, followTime=Mon Sep 11 17:12:38 CST 2017,
//areaCode=null, areaName=null, shopNo=null, shopName=null, headAddress=null, comTaskCode=null,
//dis=false, finishOrgComTask=true, remarkCom={value}初次介绍, lastResultDate=Mon Sep 11 17:12:38 CST 2017, finishAllComTask=false]
		AddClientFollow addClientFollow = new AddClientFollow();
		addClientFollow.setFollowInfo("初次介绍");
		addClientFollow.setFollowType("SYSTEM");
		addClientFollow.setNextDate(DateUtils.parseDate("2017-09-11 18:12:38", "yyyy-MM-dd hh:mm:ss"));
		addClientFollow.setTaskCode("LJ_5c0351c816e2453aaf712509fdca87c6");
		addClientFollow.setComTaskType("INVITE");
		addClientFollow.setComTaskTypeCf("FIRST_INTR");
		addClientFollow.setFollowTime(DateUtils.parseDate("2017-09-11 17:12:38", "yyyy-MM-dd hh:mm:ss"));
		addClientFollow.setDis(false);
		addClientFollow.setFinishOrgComTask(true);
		addClientFollow.setRemark("{value}初次介绍");
		addClientFollow.setLastResultDate(DateUtils.parseDate("2017-09-11 17:12:38", "yyyy-MM-dd hh:mm:ss"));
		addClientFollow.setFinishAllComTask(false);
		addClientFollow.setMemberNoGm("be077339bcad4049b7ddfe9db7aed6ae");
		addClientFollow.setMemberNo("adc5e91c44a5466d9ed92f9c5aa998b3");
		addClientFollow.setMerchantNo("1f169ad6143d46f5832535642ce2d331");
		Date date = new Date();
...
//		abandonCheckDto.setNotDealReason("其他");
	...
	@Test
	public void addCFOrder1() throws Exception {
		//AddClientFollow [merchantNo=1f169ad6143d46f5832535642ce2d331, cfNo=null, memberNo=adc5e91c44a5466d9ed92f9c5aa998b3, memberName=null, memberNoGm=be077339bcad4049b7ddfe9db7aed6ae, memberNameGm=null, followNum=null, followType=SYSTEM, followInfo=初次介绍, deal=null, status=null, orderAmount=null, nextDate=Mon Sep 11 18:12:38 CST 2017, taskCode=LJ_5c0351c816e2453aaf712509fdca87c6, taskName=null, notDealReason=null, resean=null, comTaskType=INVITE, comTaskTypeCf=FIRST_INTR, clientExpNum=null, clientInviteNum=null, clientGuidNum=null, remark=null, createId=null, remark4=null, remark3=null, remark2=null, followTime=Mon Sep 11 17:12:38 CST 2017, areaCode=null, areaName=null, shopNo=null, shopName=null, headAddress=null, comTaskCode=null, dis=false, finishOrgComTask=true, remarkCom={value}初次介绍, lastResultDate=Mon Sep 11 17:12:38 CST 2017, finishAllComTask=false]
	}
	
	@Test
	public void getClientFollowInfo() throws Exception {
		Map<String,Object> map = new HashMap<String, Object>();
		map.put("merchantNo", "1f169ad6143d46f5832535642ce2d331");
		map.put("memberNo", "100c6a56cb324ff3ab60d47e4b825d5b");
		map.put("lastTime", "2017-11-02 00:05:00");
		List<Map<String,Object>> list = clientFollowService.getClientFollowInfo(map);
