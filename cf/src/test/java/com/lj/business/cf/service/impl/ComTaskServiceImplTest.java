...
public class ComTaskServiceImplTest extends SpringTestCase{
	...
	@Test
	public void findLastRecordByMGM() throws Exception {
		FindComTask findComTask = new FindComTask();
		findComTask.setMemberNo("aa384bb4007846fdbd781a5a1876989b");
		findComTask.setMemberNoGm("8430ab66cc08459586e827ba7a71aef7");
		findComTask.setDate(new Date());
		System.out.println(comTaskService.findLastRecordByMGM(findComTask));
	}
	
	@Test
	public void testInitWorkTaskByNewGM() {
		AddWorkTaskByNewGM addWorkTaskByNewGM = new AddWorkTaskByNewGM();
		addWorkTaskByNewGM.setMerchantNo("e79d975846ee41ba8c3c55738fda66a9");
		addWorkTaskByNewGM.setShopNo("LJ_79a5ffa84c2942809b7961917d4447ef");
		addWorkTaskByNewGM.setShopName("深圳安家皇家一号店");
		addWorkTaskByNewGM.setMemberNoGm("776255e1163a4630a6fc92ce8c1b5869");
		addWorkTaskByNewGM.setMemberNameGm("曾垂瑜");
		comTaskService.initWorkTaskByNewGM(addWorkTaskByNewGM);
	}
}
