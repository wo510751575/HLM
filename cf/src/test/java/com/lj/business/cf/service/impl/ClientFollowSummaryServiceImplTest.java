...
public class ClientFollowSummaryServiceImplTest extends SpringTestCase{
	...
	@Test
	public void findCountPmOrderByGm() throws Exception {
		Map<String, Object> map = new HashMap<>();
		Calendar calendar = Calendar.getInstance();
		calendar.setTime(new Date());
		calendar.set(Calendar.HOUR, 0);
		...
		calendar.set(Calendar.MILLISECOND, 999);
		map.put("endTime", calendar.getTime());
		map.put("memberNoGm", "421e31676b784957b8baa3015f1b52d0");
		System.out.println(clientFollowSummaryService.findCountPmOrderByGm(map));
	}
	
	@Test
	public void addSummaryWithClientFollow() throws Exception {
		AddPmClientFollowFirstDto addPmClientFollowFirstDto = new AddPmClientFollowFirstDto();
		addPmClientFollowFirstDto.setMerchantNo("2169d1820e254e86b110dff73e1bd58f");
		addPmClientFollowFirstDto.setMemberNo("98f71bc7534a419e94a94b1531a0f7fb");
		addPmClientFollowFirstDto.setMemberNoGm("421e31676b784957b8baa3015f1b52d0");
		clientFollowSummaryService.addSummaryWithClientFollow(addPmClientFollowFirstDto);
	}
}
