...
public class ShopTaskSet implements Serializable{
	...
	public String toString() {
		return "ShopTaskSet [code=" + code + ", merchantNo=" + merchantNo
				+ ", shopNo=" + shopNo + ", shopName=" + shopName
				+ ", memberNoSp=" + memberNoSp + ", memberNameSp="
				+ memberNameSp + ", startDate=" + startDate + ", endDate="
				+ endDate + ", numMonth=" + numMonth + ", taskUnit=" + taskUnit
				+ ", taskType=" + taskType + ", list=" + Arrays.toString(list)
				+ "]";
	}
