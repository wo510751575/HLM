...
public class FindWorkTask implements Serializable {
	...
	public String toString() {
		return "FindWorkTask [code=" + code + ", merchantNo=" + merchantNo
				+ ", shopNo=" + shopNo + ", shopName=" + shopName
				+ ", memberNoGm=" + memberNoGm + ", memberNameGm="
				+ memberNameGm + ", taskType=" + taskType + ", codeList="
				+ codeList + ", nameList=" + nameList + ", workDate="
				+ workDate + ", requireNum=" + requireNum + ", finishNum="
				+ finishNum + ", unfinishNum=" + unfinishNum + ", defeatNum="
				+ defeatNum + ", finish=" + finish + ", reason=" + reason
				+ ", createId=" + createId + ", createDate=" + createDate
				+ ", remark4=" + remark4 + ", remark3=" + remark3
				+ ", remark2=" + remark2 + ", remark=" + remark + ", now="
				+ now + "]";
	}
