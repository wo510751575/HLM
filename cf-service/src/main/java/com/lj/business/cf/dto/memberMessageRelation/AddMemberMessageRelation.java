...
public class AddMemberMessageRelation implements Serializable { 

    /**
	 * 
	 */
	private static final long serialVersionUID = -7079818801691118970L;
	...
	public String toString() {
		return "AddMemberMessageRelation [code=" + code + ", msgNo=" + msgNo
