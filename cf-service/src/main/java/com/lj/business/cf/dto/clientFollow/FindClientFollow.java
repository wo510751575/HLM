 ...
 */
public class FindClientFollow implements Serializable {
	...
	public String toString() {
		return "FindClientFollow [code=" + code + ", cfNo=" + cfNo
				...
				+ ", followType=" + followType + ", followInfo=" + followInfo
				+ ", deal=" + deal + ", status=" + status + ", comTaskType="
				+ comTaskType + ", orderAmount=" + orderAmount + ", nextDate="
				+ nextDate + ", notDealReason=" + notDealReason + ", remark="
				+ remark + ", createId=" + createId + ", createDate="
				+ createDate + ", followTime=" + followTime + ", beginDate="
