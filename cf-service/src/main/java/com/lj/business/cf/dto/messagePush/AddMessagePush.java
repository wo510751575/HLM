...
public class AddMessagePush implements Serializable { 

    /**
	 * 
	 */
	private static final long serialVersionUID = 4360303098956323641L;
	...
	public String toString() {
		return "AddMessagePush [code=" + code + ", msgTitle=" + msgTitle
