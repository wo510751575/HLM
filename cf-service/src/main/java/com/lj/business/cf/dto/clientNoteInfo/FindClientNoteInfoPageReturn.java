...
public class FindClientNoteInfoPageReturn implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 7194438159147314279L; 
   ...
   private String memberNoGm;
	...
	public String toString() {
		return "FindClientNoteInfoPageReturn [code=" + code + ", memberNo="
