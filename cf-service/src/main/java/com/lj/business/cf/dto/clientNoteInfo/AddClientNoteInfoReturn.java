...
public class AddClientNoteInfoReturn implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 7061403053261728997L; 
	...
	public String toString() {
		return "AddClientNoteInfoReturn [code=" + code + ", memberNo="
