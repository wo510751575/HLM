...
public class AddCallChatInfo implements Serializable { 

    /**
	 * 
	 */
	private static final long serialVersionUID = 4190301552475336931L;
	...
	public String toString() {
		return "AddCallChatInfo [code=" + code + ", memberNo=" + memberNo
				+ ", memberName=" + memberName + ", mobile=" + mobile
				+ ", linkmanRemark=" + linkmanRemark + ", callTime=" + callTime
				+ ", callDate=" + callDate + ", status=" + status
