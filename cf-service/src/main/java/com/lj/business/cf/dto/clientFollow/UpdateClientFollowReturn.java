...
/**
 * The Class UpdateClientFollowReturn.
 */
public class UpdateClientFollowReturn implements Serializable {

	
	 /** Generate cron. */
	private static final long serialVersionUID = -9059736668670337229L; 
    /**
     * CODE .
     */
    private String code;
	...
	public String toString() {
		...
		builder.append("UpdateClientFollowReturn [code=").append(code)
