...
public interface IComTaskService {
	 ...
	 * 
	 *
	 * 方法说明：新增导购后初始化工作任务统计表
	 *
	 * @param addWorkTaskByNewGM
	 * @throws TsfaServiceException
	 *
	 ...
	 * 
	 *
	 * 方法说明：根据导购号和客户号查询最后一条沟通任务
	 *
	 * @param findComTask
	 * @return
	 *
	 * @author 梅宏博  CreateDate: 2017年10月26日
	 *
	 */
	 ...
	 * 
	 *
	 * 方法说明：获取FINISH等于初次介绍的客户CODE
	 *
	 * @param findComTask
	 * @return
	 *
	 * @author 罗书明 CreateDate: 2017年10月28日
	 *
	 */
	public List<FindComTaskReturn> queryComTaskFinish(FindComTask findComTask);
	 ...
	 * 
	 *
	 * 方法说明：根据导购查询每个客户最后一条沟通记录
	 *
	 * @param findComTask
	 * @return
	 *
	 * @author 梅宏博  CreateDate: 2017年12月20日
	 *
	 */
