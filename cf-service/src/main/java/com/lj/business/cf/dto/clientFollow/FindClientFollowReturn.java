...
public class FindClientFollowReturn implements Serializable { 
	...
	public void setComTaskType(String comTaskType) {
		...
		if(!StringUtils.isEmpty(this.comTaskType)){
			...
			if (StringUtils.isEmpty(this.comTaskTypeName)) {
				this.comTaskTypeName = EnumUtils.getValue(FollowType.class, this.comTaskType);
			}
		}
	}
	...
	public String toString() {
		return "FindClientFollowReturn [code=" + code + ", cfNo=" + cfNo
				+ ", merchantNo=" + merchantNo + ", memberNo=" + memberNo
				+ ", memberName=" + memberName + ", memberNoGm=" + memberNoGm
				+ ", memberNameGm=" + memberNameGm + ", followNum=" + followNum
				+ ", followType=" + followType + ", followTypeName="
				+ followTypeName + ", followInfo=" + followInfo + ", deal="
				+ deal + ", status=" + status + ", orderAmount=" + orderAmount
				+ ", nextDate=" + nextDate + ", taskCode=" + taskCode
				+ ", taskName=" + taskName + ", comTaskType=" + comTaskType
				+ ", comTaskTypeName=" + comTaskTypeName + ", clientExpNum="
				+ clientExpNum + ", clientInviteNum=" + clientInviteNum
				+ ", clientGuidNum=" + clientGuidNum + ", remark=" + remark
				+ ", notDealReason=" + notDealReason + ", createId=" + createId
