...
public class UpdateMessagePush implements Serializable { 

    /**
	 * 
	 */
	private static final long serialVersionUID = 3272382928604473459L;
	...
	public String toString() {
		return "UpdateMessagePush [code=" + code + ", msgTitle=" + msgTitle
