...
public class FindMemberMessageRelationReturn implements Serializable { 

    /**
	 * 
	 */
	private static final long serialVersionUID = 8153827482692574147L;
	...
	public String toString() {
		return "FindMemberMessageRelationReturn [code=" + code + ", msgNo="
				+ msgNo + ", merchantNo=" + merchantNo + ", merchantName="
