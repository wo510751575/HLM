...
public class AddClientFollowSummary implements Serializable { 

    /**
	 * 
	 */
	private static final long serialVersionUID = 324447939432700010L;
	...
	public String toString() {
		return "AddClientFollowSummary [code=" + code + ", merchantNo="
