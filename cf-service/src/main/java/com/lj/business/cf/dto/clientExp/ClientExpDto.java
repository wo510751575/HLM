...
public class ClientExpDto extends PageParamEntity implements Serializable {
	...
	public String toString() {
		...
		builder.append("ClientExpDto [code=").append(code).append(", merchantNo=").append(merchantNo).append(", memberNo=").append(memberNo).append(", memberName=").append(memberName)
				.append(", memberNoGm=").append(memberNoGm).append(", memberNameGm=").append(memberNameGm).append(", shopNo=").append(shopNo).append(", shopName=").append(shopName)
				.append(", expTime=").append(expTime).append(", expFb=").append(expFb).append(", imgs=").append(imgs).append(", resourcesUrl=").append(resourcesUrl).append(", expResult=")
				.append(expResult).append(", failReason=").append(failReason).append(", cfNo=").append(cfNo).append(", cfCode=").append(cfCode).append(", remark4=").append(remark4)
				.append(", remark3=").append(remark3).append(", remark2=").append(remark2).append(", remark1=").append(remark1).append(", comTaskCode=").append(comTaskCode).append(", dis=")
				.append(dis).append(", mobile=").append(mobile).append(", sex=").append(sex).append(", nickNameWx=").append(nickNameWx).append(", cityWx=").append(cityWx).append(", countryWx=")
				.append(countryWx).append(", provinceWx=").append(provinceWx).append(", headAddress=").append(headAddress).append(", pmTypeType=").append(pmTypeType).append("]");
