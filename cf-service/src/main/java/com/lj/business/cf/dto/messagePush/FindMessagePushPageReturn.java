...
public class FindMessagePushPageReturn implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -543146235755840197L; 
	...
	public String toString() {
		return "FindMessagePushPageReturn [code=" + code + ", msgTitle="
				+ msgTitle + ", msgContent=" + msgContent + ", msgType="
				+ msgType + ", pushDate=" + pushDate + ", merchantNo="
				+ merchantNo + ", merchantName=" + merchantName + ", shopNo="
				+ shopNo + ", shopName=" + shopName + ", memberNoGm="
				+ memberNoGm + ", memberNameGm=" + memberNameGm
				+ ", memberNoMsg=" + memberNoMsg + ", memberNamesMsg="
				+ memberNamesMsg + ", updateId=" + updateId + ", updateDate="
