...
public class FindCallChatInfoReturn implements Serializable { 

    /**
	 * 
	 */
	private static final long serialVersionUID = -8005607247496038182L;
	...
	public String toString() {
		return "FindCallChatInfoReturn [code=" + code + ", memberNo="
				+ memberNo + ", memberName=" + memberName + ", mobile="
				+ mobile + ", linkmanRemark=" + linkmanRemark + ", callTime="
				+ callTime + ", callDate=" + callDate + ", status=" + status
