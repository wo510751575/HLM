...
import com.lj.business.api.domain.Token;
...
public class ApiHelp extends SpringTestCase {
	...
	public static final String URL = "http://localhost/api-os/";
	//public static final String URL = "http://120.79.36.156/api-os/";
	public static final Long DEVELOPER = 661456283157610676L;
	public static final String SGIN_PARAM = "603ecce180024f27b22c3eb42bab4717";
...
//		System.out.println(distributeCache.get("APIMTOKEN" ));
		...
		businessParamMap.put("mobile","18665435142");
...
//		businessParamMap.put("limit", 0);
		doPost("apiInfoSearch/getInfoByMobile.do", businessParamMap);
...
//		String en = "bf83163aabcd28427bf6fbd9d4ad3f60";
	...
	public static void doPost(String action, Map<String, Object> businessParamMap) {
		...
		String paramContent = JsonUtils.jsonFromObject(businessParamMap);
		System.out.println("paramContent==================="+paramContent);
		params.put("paramContent", paramContent);
	//	String signature = MD5.encryptByMD5Twice(paramContent, params.get("timestamp") + SGIN_PARAM);
//		System.out.println(signature);
	//	params.put("signature", signature);
		//params.put("token", "7jrgNUk6E4z9DJZMoRHw2dTFsMv/PoIqYpBDMBbERabExBj05bVVjVJP0o00AYRj");	// 签名
		//params.put("token", login());
		params.put("apiKey", "706514455098490726");
		params.put("apiSecret", "67fd3eb428fd49dbb2e79f276f31c8b8");
...
//		String paramJson = JsonUtils.jsonFromObject(login);
		...
		paramMap.put("mobile", "18922892075");
		paramMap.put("pwd", MD5.encryptByMD5("892075"));
...
//		businessParamMap.put("memberNoShop","333M0001");
	...
	public static void post(String action ,String paramContent,String sign,String timestamp) {
		Map<String,String> params = new HashMap<>();
//		String paramContent = JsonUtils.jsonFromObject(obj);
		System.out.println("paramContent==================="+paramContent);
		params.put("paramContent", paramContent);
		params.put("timestamp",timestamp);
