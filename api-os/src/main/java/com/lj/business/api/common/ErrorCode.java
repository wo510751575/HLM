...
public interface ErrorCode {
	 ...
	 * 接入应用KEY为空
	 */
	public static final String API_KEY_IS_EMPTY = "api_key_is_empty";
	 ...
	 * 接入应用KEY过期
	 */
	public static final String API_KEY_EXPIRED = "api_app_key_expired";
	
	/**
	 * 接入应用密钥为空
	 */
	public static final String API_SECRET_IS_EMPTY = "api_secret_is_empty";
	
	/**
	 * 接入应用密钥非法
	 */
	public static final String API_SECRET_ERROR = "api_secret_is_error";
