...
import com.lj.business.api.service.TokenService;
...
public class IndexAction extends Action { 
	...
	public GeneralResponse noAuthorized(HttpServletRequest request){
		...
		if(StringUtils.isEmpty(errorCode)) {
			ResponseCode responseCode = GeneralResponse.getErrorResponseByBusinessCode(ErrorCode.ACCESS_VALID);
			generalResponse.setErrorCode(responseCode.getCode());
			generalResponse.setErrorMessage(responseCode.getMessage());
		} else {
