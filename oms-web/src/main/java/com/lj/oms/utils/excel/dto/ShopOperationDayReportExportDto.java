 ...
 */
public class ShopOperationDayReportExportDto implements Serializable{
	 ...
	 * 终端代码
	 */
	@ExcelField(title="终端代码", align=2, sort=13)
	...
	public String toString() {
		...
		builder.append("ShopOperationDayReportExportDto [reportDate=");
