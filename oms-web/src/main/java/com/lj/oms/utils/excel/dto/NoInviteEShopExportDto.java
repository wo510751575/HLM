 ...
 */
public class NoInviteEShopExportDto implements Serializable{
	 ...
	 * 
	 */
	@ExcelField(title="店长电话", align=2, sort=5)
	private String memberMobileShop;
    
    /** 客户数量. */
	@ExcelField(title="客户数量", align=3, sort=5)
    private String personNum;
    
    /** 店员数量. */
	@ExcelField(title="店员数量", align=3, sort=6)
    private String clerkNum;
	
	 /** 成单金额. */
	@ExcelField(title="成单金额", align=3, sort=7)
    private String orderAmount;
		
    /**
     * 经营范围 .
     */
	@ExcelField(title="经营范围", align=2, sort=8)
     ...
     * 开店时间.
     * */
	@ExcelField(title="开店时间", align=2, sort=10)
    private Date openDate;
     
    /** 终端状态. */
	@ExcelField(title="终端状态", align=2, sort=11)
    private String status;

    /**
     * 终端地址.
     */
	@ExcelField(title="终端地址", align=2, sort=12)
    private String addrInfo;
    
	 /**
	   *所属区域
	   */
	@ExcelField(title="所属区域", align=2, sort=13, dictType="erp_dict_1")
	...
	public String getMemberMobileShop() {
		return memberMobileShop;
	}

	public void setMemberMobileShop(String memberMobileShop) {
		this.memberMobileShop = memberMobileShop;
	}

	@Override
	public String toString() {
		StringBuilder builder = new StringBuilder();
		builder.append("NoInviteEShopExportDto [shopNoMerchant=");
		builder.append(shopNoMerchant);
		builder.append(", shopType=");
		builder.append(shopType);
		builder.append(", memberNameShop=");
		builder.append(memberNameShop);
		builder.append(", memberMobileShop=");
		builder.append(memberMobileShop);
