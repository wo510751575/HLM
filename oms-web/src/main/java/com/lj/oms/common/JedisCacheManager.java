...
//			logger.debug("Init: cacheKeyName {} ", cacheKeyName);
		...
		public V get(K key) throws CacheException {
			...
			try {
				...
				value = (V)redisCache.toObject(jedis.hget(redisCache.getBytesKey(cacheKeyName), redisCache.getBytesKey(key)));
		...
		public V put(K key, V value) throws CacheException {
			...
			try {
				jedis = redisCache.getJedis();
				jedis.hset(redisCache.getBytesKey(cacheKeyName), redisCache.getBytesKey(key), redisCache.toBytes(value));
