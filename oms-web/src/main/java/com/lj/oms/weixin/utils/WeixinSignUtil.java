...
public class WeixinSignUtil {
	...
	private static  WeixinApiService weixinApiService = null;
    ...
    public  static boolean checkIsSignValidFromResponseString(String responseString) throws ParserConfigurationException, IOException, SAXException {
		...
		//根据微信商户号及查找商户的公众号配置。
		WeixinConfigDto config= getWeixinApiService().getWeixinConfigByWxMchId(wxMchId);
    ...
    public static WeixinApiService getWeixinApiService(){
    	if(weixinApiService==null){
    		weixinApiService= new WeixinApiService();
    	}
