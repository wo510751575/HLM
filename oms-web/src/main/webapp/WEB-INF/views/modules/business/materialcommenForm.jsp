...
<div class="container">
    <ul class="nav nav-tabs">
	    ...
	    <li class="active"><a href="${ctx}/business/materialcommen/form?code=${data.code}&tempId=${data.tempId}">${not empty data.code?'公用素材修改':'公用素材添加'}</a></li>
			<%-- <li><a href="${ctx}/business/materialcommen/setting">模板添加</a></li> --%>
		</shiro:hasPermission>
    
        
    </ul><br/>

    <form id="inputForm" action="${ctx}/business/materialcommen/${not empty data.code?'edit':'save'}"  method="post" enctype="multipart/form-data" class="form-horizontal">
          ...
          <div class="control-group">
           ...
           <%--  <div class="control-group">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" id="title" name="title"  maxlength="60" class="required input-xxlarge" value="${data.title}"/>
                    <span class="help-inline"><font color="red">*</font></span>
                </div>
            </div>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                 <textarea class="editor input-xxlarge required" rows="5" maxlength="400" name="brief" >${data.brief }</textarea>
                    <span class="help-inline"><font color="red">*</font></span>
                </div>
            </div>
	                      ...
	                      success:function(result){
	                    	...
	                    	if(result){
	                    		for(var i = 0; i < result.length; i++){
			                    	codeListSec.append("<option value='" + result[i].shopNo + "' class='" + result[i].shopNo + "' >" + result[i].shopName + "</option>");
	                    		}
