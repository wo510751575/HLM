...
<div class="container">
    <ul class="nav nav-tabs">
        <li><a href="${ctx}/business/materialtype/list">素材类型列表</a></li>
	    <li class="active"><a href="${ctx}/business/materialtype/form?code=${data.code}">${not empty data.code?'素材类型修改':'素材类型添加'}</a></li> 
    </ul><br/>
    <form id="inputForm" action="${ctx}/business/materialtype/${not empty data.code?'edit':'save'}" onsubmit="return false;" method="post" enctype="multipart/form-data" class="form-horizontal">
