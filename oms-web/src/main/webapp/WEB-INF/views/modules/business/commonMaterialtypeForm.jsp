...
<html>
<head>
    <title>${not empty data.code?'公司素材类型修改':'公司素材类型添加'}</title>
...
<div class="container">
    <ul class="nav nav-tabs">
        <li><a href="${ctx}/business/commonMaterialtype/list">公司素材类型列表</a></li>
	    <li class="active"><a href="${ctx}/business/commonMaterialtype/form?code=${data.code}">${not empty data.code?'公司素材类型修改':'公司素材类型添加'}</a></li> 
    </ul><br/>
    <form id="inputForm" action="${ctx}/business/commonMaterialtype/${not empty data.code?'edit':'save'}" onsubmit="return false;" method="post" enctype="multipart/form-data" class="form-horizontal">
