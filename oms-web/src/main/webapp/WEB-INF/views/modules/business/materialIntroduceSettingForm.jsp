...
<div class="container">
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/business/materialIntroduce/setting/">素材模版列表</a></li>
		<li class="active"><a href="${ctx}/business/materialIntroduce/settingForm?id=${data.id}">素材模版添加</a></li>
	</ul><br/>
	<form id="inputForm" action="${ctx}/business/materialIntroduce/settingSave" method="post" class="form-horizontal">
