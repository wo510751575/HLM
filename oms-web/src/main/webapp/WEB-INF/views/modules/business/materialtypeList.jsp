...
<div class="container">
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/business/materialtype/list">素材类型列表</a></li>
<%-- 		<shiro:hasPermission name="member:guid:edit"> --%>
			<li><a href="${ctx}/business/materialtype/form">素材类型添加</a></li>
<%-- 		</shiro:hasPermission> --%>
	</ul>
 	<form id="searchForm" action="${ctx}/business/materialtype" method="post" class="breadcrumb form-search">
			...
			<tr>
				...
				<c:choose>
					<c:when test="${empty merchantNo}">
						<td>
							<a href="${ctx}/business/materialtype/form?code=${item.code}">修改</a>
						</td>
					</c:when>
					<c:otherwise>
						<td>
