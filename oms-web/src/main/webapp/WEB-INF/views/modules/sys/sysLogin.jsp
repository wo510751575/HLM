...
<html>
<head>
    <title>${fns:getConfig('productName')} 深圳扬恩科技有限公司</title>
    ...
    <div id="loginPage">
      <div id="section_one" class="section">
          ...
          <div class="bottom"> 
			...
			<div  style='right:80%;top:50%'>
				<p><font color="#FFFFFF" size="5">深圳扬恩科技有限公司</font></p>
				<p></p>
				<p></p>
				
		       <p><font color="#FFFFFF" size="5">国内最大社交用户聚集平台微信，打造强大的智能客户跟进管理系统，</font></p>
		       <p><font color="#FFFFFF" size="5">助您智能跟进高效成单。    精准分类无缝衔接的客户分组及任务系统，</font></p>
		       <p><font color="#FFFFFF" size="5">助您轻松高效管理客户。</font></p>
		      
		       </div>
              <div class="right_item" style='right:10%;top:30%'>
              	<h1 class="form-signin-heading">OMS</h1>
         ...
         <div class="footer">
		<p>Copyright © 2018 <a href="/oms-web">深圳扬恩科技有限公司</a> -V1.1.0</p>
		<p><a href="http://www.miitbeian.gov.cn">粤ICP备16093445号-1</a></p>  
	    </div>
