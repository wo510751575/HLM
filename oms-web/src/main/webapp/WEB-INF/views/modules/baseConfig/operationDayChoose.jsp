...
<div class="container">
	...
	<form id="searchForm" action="${ctx}/baseConfig/stList/operationDayChooseSave" method="post" class="breadcrumb form-search">
                ...
                <div class="cameraBox cameraBoxLeft" style="float: left;">
		 			<p>已选择的报表项目</p>
		 				<select class="form-control " id="inSec" name="stLists" multiple="multiple" style="height: 360px;">
	                    	<c:forEach items="${operationDayChooses}" var="item">
