...
<div class="container">
	...
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/rw/articleType/">文章类型列表</a></li>		
		<li><a href="${ctx}/rw/articleType/form">文章类型添加</a></li>	
	</ul>
	<form id="searchForm" action="${ctx}/rw/articleType/" method="post" class="breadcrumb form-search">
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		<thead>
			<tr>
				...
				<th>排序</th>
				<th>更新时间</th>
				<shiro:hasPermission name="rw:articleType:edit">
				<th>操作</th>
				</shiro:hasPermission>
			</tr>
		</thead>
		...
		<c:forEach items="${page.list}" var="item" varStatus="number"> 
			<tr>		
				...
				<shiro:hasPermission name="rw:articleType:edit">		
				<td>
					<a href="${ctx}/rw/articleType/form?code=${item.code}">修改</a>
					<a href="${ctx}/rw/articleType/delete?code=${item.code}" onclick="return confirmx('确认要删除该文章类型吗？', this.href)">删除</a>
				</td>
				</shiro:hasPermission>
			</tr>
		</c:forEach>
