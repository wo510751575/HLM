...
<div class="container">
    ...
    <ul class="nav nav-tabs">
	    ...
	    <li class="active"><a href="${ctx}/cm/wordsInfo/form?code=${data.code}">${not empty data.code?'话术修改':'话术添加'}</a></li> 
    </ul>
     <tags:message content="${message}"/>
     <form id="inputForm" action="${ctx}/cm/wordsInfo/${not empty data.code?'edit':'save'}" method="post" enctype="multipart/form-data" class="form-horizontal">
