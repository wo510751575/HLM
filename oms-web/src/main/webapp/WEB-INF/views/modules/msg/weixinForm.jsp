...
<html>
<head>
    <title>${not empty data.code?'微信群发列表':'微信群发添加'}</title>
    ...
    $(document).ready(function() {
      ...
      $(".select2-input").on("input propertychange",function(){
       ...
       $("#codeListSec").on("change",function(e){
    	   ...
    	   $.ajax({
               type:"POST",
               url:"${ctx}/msg/weixin/materialShow",
               data:{code:txt},
               dataType:'JSON',
               success:function(result){
...
<div class="container clearfix">
    <ul class="nav nav-tabs">
        <li><a href="${ctx}/msg/weixin">微信群发列表</a></li>
	    <li class="active"><a href="${ctx}/msg/weixin/form?code=${data.code}">${not empty query.id?'微信群发修改':'新建微信群发'}</a></li> 
    </ul><br>
     <tags:message content="${message}"/>
     <div class="active_config">
     <form id="inputForm" action="${ctx}/msg/weixin/${not empty data.code?'edit':'save'}" onsubmit="return false;" method="post" enctype="multipart/form-data" class="form-horizontal">    
           ...
           <div class="control-group">
               <label class="control-label">所在地区:</label>
                <div class="controls">
                    <input type="text" id="area" name="area"  maxlength="100" class="input-medium" value="${paramMember.area}" placeholder="省/市"/>
