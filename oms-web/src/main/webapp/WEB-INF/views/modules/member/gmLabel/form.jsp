...
<html>
<head>
    <title>${not empty data.code?'个人标签修改':'个人标签添加'}</title>
...
<div class="container">
    <ul class="nav nav-tabs">
        <li><a href="${ctx}/member/gmLabel">个人标签列表</a></li>
	    <li class="active"><a href="${ctx}/member/gmLabel/form?code=${data.code}">${not empty data.code?'个人标签修改':'个人标签添加'}</a></li> 
    </ul><br/>
    <form id="inputForm" action="${ctx}/member/gmLabel/${not empty data.code?'edit':'save'}" onsubmit="return false;" method="post" enctype="multipart/form-data" class="form-horizontal">
