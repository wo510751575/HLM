...
<html>
<head>
    <title>${not empty data.code?'服务产品修改':'服务产品添加'}</title>
...
<div class="container">
    <ul class="nav nav-tabs">
        <li><a href="${ctx}/member/serviceProduct">服务项目列表</a></li>
	    <li class="active"><a href="${ctx}/member/serviceProduct/form?code=${data.code}">${not empty data.code?'服务项目修改':'服务项目添加'}</a></li> 
    </ul>
     <tags:message content="${message}"/>
     <form id="inputForm" action="${ctx}/member/serviceProduct/${not empty data.code?'edit':'save'}" method="post" enctype="multipart/form-data" class="form-horizontal">
        ...
        <div id="base_div" class="tab_div">   
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" id="productName" name="productName"  maxlength="20" class="required input-xlarge" value="${data.productName}"/>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                 <textarea class="editor input-xxlarge required" rows="5" name="keywords"  maxlength="100">${data.keywords }</textarea>关键字，多个用英文逗号隔开
                    <span class="help-inline"><font color="red">*</font></span>
                </div>
            </div>
	...
	<script>
		...
		var uploader = new plupload.Uploader({ //实例化一个plupload上传对象
			...
			url : '${ctx}/file/upload?dirName=serviceProductCover',
		...
		var uploader = new plupload.Uploader({ //实例化一个plupload上传对象
			...
			url : '${ctx}/file/upload?dirName=serviceProductImg',
			multi_selection : false,
			auto_start : true,
			flash_swf_url : '${ctxStatic}/common/Moxie.swf',
			silverlight_xap_url : '${ctxStatic}/common/Moxie.xap',
