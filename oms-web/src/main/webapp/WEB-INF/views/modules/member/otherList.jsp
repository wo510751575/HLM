...
<div class="container">
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/member/otherList/">非意向客户列表</a></li>
	</ul>
	
	
	<form id="searchForm" action="${ctx}/member/otherList/" method="post" class="breadcrumb form-search">
...
<%-- 					<a href="${ctx}/weixin/chatInfo?talker=${member.noWx}">聊天记录</a> --%>
					<a href="${ctx}/cf/list?memberNo=${member.memberNo}&memberNoGm=${member.memberNoGm}">跟进记录</a>
