...
<div class="container">
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/member/terminalImStatus/batteryLevel">中控端监控</a></li>
		<li class="active"><a href="${ctx}/member/terminalImStatus/gmBatteryLevel">导购端监控</a></li>		
	</ul>
	<form id="searchForm" action="${ctx}/member/terminalImStatus/gmBatteryLevel" method="post" class="breadcrumb form-search">
