...
<div class="container">
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/member/gmLabel/">个人标签列表</a></li>
		<li><a href="${ctx}/member/gmLabel/form">新增个人标签</a></li>
	</ul>
	<form id="searchForm" action="${ctx}/member/gmLabel/" method="post" class="breadcrumb form-search">
		<input id="pageNo" name="pageNo" type="hidden" value="${page.pageNo}"/>
		<input id="pageSize" name="pageSize" type="hidden" value="${page.pageSize}"/>
		<ul class="ul-form">
			<li><label style="width: 100px;">标签名称：</label>
				<input type="text" name="labelName" class="input-medium" maxlength="100" value="${findGmLabelPage.param.labelName}" placeholder="标签名称">
			</li>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="item" varStatus="number"> 
			<tr>
				...
				<td>
					<a href="${ctx}/member/gmLabel/form?code=${item.code}">修改</a>
				</td>
			</tr>
		</c:forEach>
		</tbody>
