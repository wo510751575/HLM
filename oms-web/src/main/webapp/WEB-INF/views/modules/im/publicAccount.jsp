...
<input type="hidden" value="publicACC" id="MATERIALLISTTYPEID"/><!-- 素材类型列表 -->
...
<!-- 					</select> -->
		...
		<div class="shop_nav shop_navThree">
			<div class="titleBack" onclick="newsList()">返回1</div>
			<div class="shop_search telescopicButton">
				<img src="${ctxStatic}/admin/images/imImages/hb-icon.png" class="telescopicImage up"/>
				<div class="search_bord">
		...
		<div class="con_right " id="topfS" style="padding: 0px">
			<ul class="friendItem" style="margin: 0px 20px">
				<li class="friendItemActive"  onclick="chosePublicAcc(1,this)">公众号列表</li>
				<li class="reply" onclick="chosePublicAcc(0,this)">无效公众号</li>
			</ul>
			<div class="FContent" id="gzhScroll">
				<ul></ul>
			</div>
		</div>
...
<div class="loadFlag" id="loadFlag" onclick="$('#loadFlag').hide();window.clearInterval(fCycle);">
 ...
 <script src="${ctxStatic}/admin/js/im/publicAcc.js?v=11" type="text/javascript"></script>
