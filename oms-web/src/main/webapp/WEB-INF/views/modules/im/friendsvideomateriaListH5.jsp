...
<div class="lj-main">
	...
	<div class="lj-right telescopicButton">
	    ...
	    <div class="top">
	        ...
	        <a href="${ctx }/im/friendsVideoMaterialForm?code=" class="btn" >创建视频素材</a>
	    </div>
	    <div class="search">
...
<script src="${ctxStatic}/admin/js/im/friendsvideomateriaListH5.js?v=11" type="text/javascript"></script>
</body>
</html>