...
<head>
    <title>${not empty data.code?'广告类型修改':'广告类型添加'}</title>
...
<body>
    <div class="container">
        ...
        <ul class="nav nav-tabs">
            <li><a href="${ctx}/ad/advertiseType/">广告类型列表</a></li>
            <li class="active"><a href="${ctx}/ad/advertiseType/form?code=${data.code}">${not empty data.code?'广告类型修改':'广告类型添加'}</a></li>
        </ul>
        <tags:message content="${message}" />
        <form id="inputForm" action="${ctx}/ad/advertiseType/${not empty data.code?'edit':'save'}" method="post" enctype="multipart/form-data" class="form-horizontal">
