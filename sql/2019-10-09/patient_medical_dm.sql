...
Date: 2019-10-09 16:45:05
*/

SET FOREIGN_KEY_CHECKS=0;

-- ----------------------------
-- Table structure for patient_medical_dm
-- ----------------------------
DROP TABLE IF EXISTS `patient_medical_dm`;
CREATE TABLE `patient_medical_dm` (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='患者病历-处置与医嘱中间表';
