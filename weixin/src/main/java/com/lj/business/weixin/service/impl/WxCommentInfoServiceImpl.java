...
public class WxCommentInfoServiceImpl implements IWxCommentInfoService { 
	...
	public UpdateWxCommentInfoReturn updateWxCommentInfo(
		...
		logger.debug("updateWxCommentInfo(UpdateWxCommentInfo updateWxCommentInfo={}) - start", updateWxCommentInfo); 
		...
		try {
			...
			logger.debug("updateWxCommentInfo(UpdateWxCommentInfo) - end - return value={}", updateWxCommentInfoReturn); 
	...
	public FindWxCommentInfoReturn findWxCommentInfo(
		...
		logger.debug("findWxCommentInfo(FindWxCommentInfo findWxCommentInfo={}) - start", findWxCommentInfo); 
		...
		try {
			...
			logger.debug("findWxCommentInfo(FindWxCommentInfo) - end - return value={}", findWxCommentInfoReturn); 
	...
	public Page<FindWxCommentInfoPageReturn> findWxCommentInfoPage(
			...
			throws TsfaServiceException {
		logger.debug("findWxCommentInfoPage(FindWxCommentInfoPage findWxCommentInfoPage={}) - start", findWxCommentInfoPage); 
		...
		logger.debug("findWxCommentInfoPage(FindWxCommentInfoPage) - end - return value={}", returnPage); 
		return  returnPage;
	}
	...
	public List<FindWxCommentInfoPageReturn> findWxCommentInfos(
			FindWxCommentInfoPage findWxCommentInfoPage)
			throws TsfaServiceException {
		logger.debug("findWxCommentInfos(findWxCommentInfos findWxCommentInfoPage={}) - start", findWxCommentInfoPage); 
		...
		logger.debug("findWxCommentInfos(FindWxCommentInfoPage) - end - return value={}", returnList); 
		return  returnList;
	} 
