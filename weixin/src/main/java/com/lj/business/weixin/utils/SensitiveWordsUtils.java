...
public class SensitiveWordsUtils {
	...
	public static void main(String[] args) {
		...
		System.out.println("敏感词的数量：" + SensitiveWordsUtils.sensitiveWordMap.size());
		...
		// 是否含有关键字
		boolean result = SensitiveWordsUtils.contains(string);
		System.out.println(result);
		result = SensitiveWordsUtils.contains(string, SensitiveWordsUtils.MinMatchTYpe);
		System.out.println(result);

		// 获取语句中的敏感词
		Set<String> set = SensitiveWordsUtils.getSensitiveWord(string);
		System.out.println("语句中包含敏感词的个数为：" + set.size() + "。包含：" + set);
		set = SensitiveWordsUtils.getSensitiveWord(string, SensitiveWordsUtils.MinMatchTYpe);
		System.out.println("语句中包含敏感词的个数为：" + set.size() + "。包含：" + set);

		// 替换语句中的敏感词
		String filterStr = SensitiveWordsUtils.replaceSensitiveWord(string, '*');
		System.out.println(filterStr);
		filterStr = SensitiveWordsUtils.replaceSensitiveWord(string, '*', SensitiveWordsUtils.MinMatchTYpe);
		System.out.println(filterStr);

		String filterStr2 = SensitiveWordsUtils.replaceSensitiveWord(string, "[*敏感词*]");
		System.out.println(filterStr2);
		filterStr2 = SensitiveWordsUtils.replaceSensitiveWord(string, "[*敏感词*]", SensitiveWordsUtils.MinMatchTYpe);
		System.out.println(filterStr2);
	}
}
