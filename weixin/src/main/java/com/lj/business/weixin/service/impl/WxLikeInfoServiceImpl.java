...
public class WxLikeInfoServiceImpl implements IWxLikeInfoService {
	...
	public UpdateWxLikeInfoReturn updateWxLikeInfo(
		...
		logger.debug("updateWxLikeInfo(UpdateWxLikeInfo updateWxLikeInfo={}) - start", updateWxLikeInfo); 
		...
		try {
			...
			logger.debug("updateWxLikeInfo(UpdateWxLikeInfo) - end - return value={}", updateWxLikeInfoReturn); 
	...
	public FindWxLikeInfoReturn findWxLikeInfo(
		...
		logger.debug("findWxLikeInfo(FindWxLikeInfo findWxLikeInfo={}) - start", findWxLikeInfo); 
		...
		try {
			...
			logger.debug("findWxLikeInfo(FindWxLikeInfo) - end - return value={}", findWxLikeInfoReturn); 
	...
	public List<Map<String, String>> findWxLikeInfos(Map<String, Object> map) {
		logger.debug("findWxLikeInfos(findWxLikeInfos map={}) - start", map); 
