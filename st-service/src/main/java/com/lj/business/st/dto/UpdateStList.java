...
/**
 * The Class UpdateStList.
 */
public class UpdateStList implements Serializable { 

     /** Generate cron. */
	private static final long serialVersionUID = 6342324746005728770L;
	...
	public String toString() {
		return "UpdateStList [code=" + code + ", nameList=" + nameList
