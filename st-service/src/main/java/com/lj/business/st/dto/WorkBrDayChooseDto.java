 ...
 */
public class WorkBrDayChooseDto implements Serializable{
	
	     /** Generate cron. */
	private static final long serialVersionUID = 2645143317563401297L;
		...
		public String toString() {
			return "WorkBrDayChooseDto [code=" + code + ", merchantNo="
					...
					+ typeList + ", imgAddr=" + imgAddr + ", seq=" + seq
