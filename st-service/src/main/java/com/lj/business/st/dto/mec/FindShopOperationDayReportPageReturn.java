...
public class FindShopOperationDayReportPageReturn implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -1451333276453430257L; 
    /**
     * code .
     */
    private String code;
	...
	public String toString() {
		...
		builder.append("FindShopOperationDayReportPageReturn [code=");
		builder.append(code);
