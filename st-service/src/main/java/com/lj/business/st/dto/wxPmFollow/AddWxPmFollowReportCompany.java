...
public class AddWxPmFollowReportCompany implements Serializable { 

    /**
     * 
     */
    private static final long serialVersionUID = 4014270341760255498L;
    ...
    public String toString() {
        ...
        builder.append("AddWxPmFollowReportCompany [code=");
        builder.append(code);
