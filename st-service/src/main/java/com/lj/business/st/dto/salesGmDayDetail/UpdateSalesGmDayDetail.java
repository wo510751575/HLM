...
/**
 * The Class UpdateSalesGmDayDetail.
 */
public class UpdateSalesGmDayDetail implements Serializable { 

    /** The Constant serialVersionUID. */
	private static final long serialVersionUID = -8681535560022341972L;
	...
	public String toString() {
		...
		builder.append("UpdateSalesGmDayDetail [code=").append(code)
