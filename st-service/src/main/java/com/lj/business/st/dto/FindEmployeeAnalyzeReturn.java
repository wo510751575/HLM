...
/**
 * The Class FindEmployeeAnalyzeReturn.
 */
public class FindEmployeeAnalyzeReturn implements Serializable { 

     /** Generate cron. */
	private static final long serialVersionUID = 6589596312651829548L;
	...
	public String toString() {
		return "FindEmployeeAnalyzeReturn [code=" + code + ", merchantNo="
