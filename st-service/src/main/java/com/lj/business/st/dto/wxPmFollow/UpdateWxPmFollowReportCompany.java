...
public class UpdateWxPmFollowReportCompany implements Serializable { 

    /**
     * 
     */
    private static final long serialVersionUID = -724638968055853854L;
    ...
    public String toString() {
        ...
        builder.append("UpdateWxPmFollowReportCompany [code=");
        builder.append(code);
