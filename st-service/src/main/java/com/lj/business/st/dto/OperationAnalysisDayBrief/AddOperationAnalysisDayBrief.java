...
public class AddOperationAnalysisDayBrief implements Serializable { 
     ...
     /**
	     ...
	     * @throws 
	     */
	private static final long serialVersionUID = -8610073241527156000L;
   ...
   private Date daySt;
	...
	public String toString() {
		return "AddOperationAnalysisDayBrief [code=" + code + ", merchantNo="
