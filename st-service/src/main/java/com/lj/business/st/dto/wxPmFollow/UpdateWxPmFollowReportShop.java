...
public class UpdateWxPmFollowReportShop implements Serializable { 

    /**
     * 
     */
    private static final long serialVersionUID = -6356433024253249580L;
    ...
    public String toString() {
        ...
        builder.append("UpdateWxPmFollowReportShop [code=");
        builder.append(code);
