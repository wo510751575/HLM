...
public class FindTodayMemberSummaryReturn implements Serializable { 

    /**
	 * 
	 */
	private static final long serialVersionUID = -8033199373218303915L;
	...
	/**
	 * @param unscanCount the unscanCount to set
	 */
	...
	/**
	 * @return the uninfoCount
	 */
	public Integer getUninfoCount() {
		return uninfoCount;
	}

	/**
	 * @param uninfoCount the uninfoCount to set
	 */
	public void setUninfoCount(Integer uninfoCount) {
		this.uninfoCount = uninfoCount;
	}
	...
	public String toString() {
		...
		builder.append("FindTodayMemberSummaryReturn [code=");
		builder.append(code);
		...
		builder.append(scanCount);
		builder.append(", unscanCount=");
		builder.append(unscanCount);
		builder.append(", unscanReason=");
		builder.append(unscanReason);
		builder.append(", infoCount=");
		builder.append(infoCount);
		builder.append(", uninfoCount=");
		builder.append(uninfoCount);
