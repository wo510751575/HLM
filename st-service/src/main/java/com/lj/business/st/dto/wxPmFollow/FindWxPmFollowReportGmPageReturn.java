...
public class FindWxPmFollowReportGmPageReturn implements Serializable {

    /**
     * 
     */
    private static final long serialVersionUID = 250625244537353751L; 
    ...
    public String toString() {
        ...
        builder.append("FindWxPmFollowReportGmPageReturn [code=");
        builder.append(code);
