...
public class AddWxPmFollowReportShop implements Serializable { 

    /**
     * 
     */
    private static final long serialVersionUID = -7166993980399076207L;
    ...
    public String toString() {
        ...
        builder.append("AddWxPmFollowReportShop [code=");
        builder.append(code);
