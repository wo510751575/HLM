...
public class FindWxPmFollowReportShopPageReturn implements Serializable {

    /**
     * 
     */
    private static final long serialVersionUID = -1640246441973397289L; 
    ...
    public String toString() {
        ...
        builder.append("FindWxPmFollowReportShopPageReturn [code=");
        builder.append(code);
