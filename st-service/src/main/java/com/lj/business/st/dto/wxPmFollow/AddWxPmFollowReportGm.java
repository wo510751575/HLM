...
public class AddWxPmFollowReportGm implements Serializable { 

    /**
     * 
     */
    private static final long serialVersionUID = 3140316024147497352L;
    ...
    public String toString() {
        ...
        builder.append("AddWxPmFollowReportGm [code=");
        builder.append(code);
