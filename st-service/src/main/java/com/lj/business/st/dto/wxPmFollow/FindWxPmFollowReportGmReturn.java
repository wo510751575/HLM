...
public class FindWxPmFollowReportGmReturn implements Serializable { 

    /**
     * 
     */
    private static final long serialVersionUID = -3471041941684789343L;
    ...
    public String toString() {
        ...
        builder.append("FindWxPmFollowReportGmReturn [code=");
        builder.append(code);
