...
/**
 * The Class FindSalesGmDayDetailReturn.
 */
public class FindSalesGmDayDetailReturn implements Serializable { 

    /** The Constant serialVersionUID. */
	private static final long serialVersionUID = 3000011299013197339L;
	...
	public String toString() {
		...
		builder.append("FindSalesGmDayDetailReturn [code=").append(code)
