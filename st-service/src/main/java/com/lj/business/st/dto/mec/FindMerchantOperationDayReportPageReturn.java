...
public class FindMerchantOperationDayReportPageReturn implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -1444795901734795751L; 
	...
	public String toString() {
		...
		builder.append("FindMerchantOperationDayReportPageReturn [code=");
		builder.append(code);
