...
/**
 * The Class FindSalesGmDayFirstReturn.
 */
public class FindSalesGmDayFirstReturn implements Serializable { 

    /** The Constant serialVersionUID. */
	private static final long serialVersionUID = -6699627888162307066L;
	...
	public String toString() {
		...
		builder.append("FindSalesGmDayFirstReturn [code=").append(code)
