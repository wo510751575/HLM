...
public class UpdateWorkRatioGm implements Serializable { 
	...
	public String toString() {
		return "UpdateWorkRatioGm [code=" + code + ", merchantNo=" + merchantNo
				...
				+ numOrder + ", numRead=" + numRead + ", numSocial="
				+ numSocial + ", numPmCf=" + numPmCf + ", numPmCfDay="
				+ numPmCfDay + ", numCfDay=" + numCfDay + ", numPmKeep="
				+ numPmKeep + ", ratioWorkRank=" + ratioWorkRank
				+ ", numPmRank=" + numPmRank + ", numPmAddRank=" + numPmAddRank
				+ ", numSaleRank=" + numSaleRank + ", numOrderRank="
				+ numOrderRank + ", numReadRank=" + numReadRank
				+ ", ratioWorkRankYtd=" + ratioWorkRankYtd + ", numPmRankYtd="
				+ numPmRankYtd + ", numPmAddRankYtd=" + numPmAddRankYtd
				+ ", numSaleRankYtd=" + numSaleRankYtd + ", numOrderRankYtd="
				+ numOrderRankYtd + ", numReadRankYtd=" + numReadRankYtd
				+ ", daySt=" + daySt + ", dimensionSt=" + dimensionSt
				+ ", createDate=" + createDate + ", numVisit=" + numVisit
				+ ", numVisitRank=" + numVisitRank + ", numVisitRankYtd="
				+ numVisitRankYtd + "]";
	}
}
