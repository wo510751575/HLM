...
public class FindWxPmFollowReportShopReturn implements Serializable { 

    /**
     * 
     */
    private static final long serialVersionUID = 8139354961373151865L;
    ...
    public String toString() {
        ...
        builder.append("FindWxPmFollowReportShopReturn [code=");
        builder.append(code);
