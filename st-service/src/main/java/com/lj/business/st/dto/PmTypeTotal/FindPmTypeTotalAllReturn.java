...
public class FindPmTypeTotalAllReturn implements Serializable { 
    ...
    /** 统计数据. */
    private List<FindPmTypeTotalReturn> list ;
	...
	public List<FindPmTypeTotalReturn> getList() {
		return list;
	}

	public void setList(List<FindPmTypeTotalReturn> list) {
		this.list = list;
	}
	...
	public String toString() {
		...
		builder.append("FindPmTypeTotalAllReturn [textInfo1=")
