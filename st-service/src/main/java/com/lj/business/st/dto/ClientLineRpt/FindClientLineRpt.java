package com.lj.business.st.dto.ClientLineRpt;

import java.io.Serializable;
import java.math.BigDecimal;
import java.util.Date;

public class FindClientLineRpt implements Serializable {
	 ...
	 /**
	     ...
	     * @throws 
	     */
	private static final long serialVersionUID = 896197906836669823L; 
	/**
     * CODE .
     */
    private String code;
	...
	public String toString() {
		...
		builder.append("AddClientLineRpt [code=").append(code)
				...
				.append(", codeLine=").append(codeLine).append(", lineName=")
				.append(lineName).append(", ratioLine=").append(ratioLine)
