...
/**
 * The Class UpdateSalesGmDayFirst.
 */
public class UpdateSalesGmDayFirst implements Serializable { 

    /** The Constant serialVersionUID. */
	private static final long serialVersionUID = 2396990176708478045L;
	...
	public String toString() {
		...
		builder.append("UpdateSalesGmDayFirst [code=").append(code)
