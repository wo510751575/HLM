...
public class FindWxPmFollowReportCompanyPageReturn implements Serializable {

    /**
     * 
     */
    private static final long serialVersionUID = -6962341902330320969L; 
    ...
    public String toString() {
        ...
        builder.append("FindWxPmFollowReportCompanyPageReturn [code=");
        builder.append(code);
