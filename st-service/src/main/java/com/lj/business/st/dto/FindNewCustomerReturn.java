...
public class FindNewCustomerReturn implements Serializable {
	...
	public String toString() {
		...
		builder.append("FindNewCustomerReturn [totalCustomerNum=")
				.append(totalCustomerNum).append(", maxDatas=")
				.append(maxDatas).append(", datas=").append(datas).append("]");
