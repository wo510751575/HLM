...
public class AdvertiseShowDto implements Serializable {
	...
	private List<String> articleCodeList;
	...
	public List<String> getArticleCodeList() {
		return articleCodeList;
	}

	public void setArticleCodeList(List<String> articleCodeList) {
