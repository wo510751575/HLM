...
public class UpdateCouponRecords implements Serializable { 

    /**
	 * 
	 */
	private static final long serialVersionUID = -1493428032466574746L;
	...
	public String toString() {
		...
		builder.append("UpdateCouponRecords [code=");
		builder.append(code);
