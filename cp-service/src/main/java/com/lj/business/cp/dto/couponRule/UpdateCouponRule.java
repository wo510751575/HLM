...
public class UpdateCouponRule implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 7757666970945274276L;
	...
	public String toString() {
		...
		builder.append("UpdateCouponRule [code=");
		builder.append(code);
