...
public class MecFileUtils {

	private static long maxSize = 10485760;// 10M文件大小
	private static Logger logger = Logger.getLogger(MecFileUtils.class);
	 ...
	 * @param @return   fileName文件全路径 
	 * @return String    返回类型 
	 */
	public static String imgScale(String fileName, InputStream inputStream, Integer height, Integer width, boolean flag, Integer reloate) {
...
//			break;
	 ...
	 * @throws IOException 
	 */
	public static String imgScale64(String filePath, Integer height, Integer width, boolean b,
			Integer reloate, String img64Str) throws IOException {
		...
		String key = GUID.generateByIP() + ".jpeg";
		...
		return imgScale(imgFile.getAbsolutePath(), inputStream, height, width, b, reloate);
	}
