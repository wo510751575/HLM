...
public class PatientServiceAdvisoryDto implements Serializable { 
	...
	public String toString() {
		return "PatientServiceAdvisoryDto [code=" + code + ", patientReservationCode=" + patientReservationCode
				+ ", patientNo=" + patientNo + ", patientName=" + patientName + ", visitingDate=" + visitingDate
				+ ", projectCodes=" + projectCodes + ", projectNames=" + projectNames + ", advisoryContent="
				+ advisoryContent + ", explainRemark=" + explainRemark + ", want=" + want + ", createDate=" + createDate
