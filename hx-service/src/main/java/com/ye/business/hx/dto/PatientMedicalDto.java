...
public class PatientMedicalDto implements Serializable { 
	...
	public String toString() {
		return "PatientMedicalDto [code=" + code + ", patientReservationCode=" + patientReservationCode + ", patientNo="
				+ patientNo + ", patientName=" + patientName + ", doctorNo=" + doctorNo + ", doctorName=" + doctorName
				+ ", assistantNo=" + assistantNo + ", assistantName=" + assistantName + ", visitingDate=" + visitingDate
				+ ", visitingType=" + visitingType + ", mainRemark=" + mainRemark + ", mainCurrentRemark="
				+ mainCurrentRemark + ", mainPastRemark=" + mainPastRemark + ", checkOralRemark=" + checkOralRemark
				+ ", checkAuxiliaryRemark=" + checkAuxiliaryRemark + ", planDiagnosisRemark=" + planDiagnosisRemark
				+ ", planTreatmentRemark=" + planTreatmentRemark + ", dmDisposalRemark=" + dmDisposalRemark
