...
public class ShopServerDetailDto implements Serializable { 
    ...
    /** 门诊服务code(fk:shop_server.code) List */
    private List<String> shopServerCodes;
	...
	public List<String> getShopServerCodes() {
		return shopServerCodes;
	}

	public void setShopServerCodes(List<String> shopServerCodes) {
		this.shopServerCodes = shopServerCodes;
	}

	@Override
	public String toString() {
		return "ShopServerDetailDto [code=" + code + ", shopServerCode=" + shopServerCode + ", serverCode=" + serverCode
				+ ", serverName=" + serverName + ", userType=" + userType + ", price=" + price + ", serverNum="
				+ serverNum + ", useNum=" + useNum + ", unuseNum=" + unuseNum + ", freezeNum=" + freezeNum
				+ ", updateId=" + updateId + ", updateDate=" + updateDate + ", createId=" + createId + ", createDate="
				+ createDate + ", isShop=" + isShop + ", serverDesc=" + serverDesc + ", shopServerCodes="
				+ shopServerCodes + "]";
	}
