...
public class HxClueDto implements Serializable { 
	...
	public String toString() {
		return "HxClueDto [code=" + code + ", name=" + name + ", phone=" + phone + ", sex=" + sex + ", age=" + age
				+ ", province=" + province + ", city=" + city + ", area=" + area + ", addrInfo=" + addrInfo
				+ ", source=" + source + ", wechatNo=" + wechatNo + ", wechatName=" + wechatName + ", userType="
				+ userType + ", userPrice=" + userPrice + ", status=" + status + ", validStatus=" + validStatus
				+ ", createTime=" + createTime + ", orderNo=" + orderNo + ", project=" + project + ", reserveDate="
				+ reserveDate + ", reserveTime=" + reserveTime + ", followName=" + followName + ", wishLevel="
				+ wishLevel + ", complaint=" + complaint + ", remark=" + remark + "]";
	}
