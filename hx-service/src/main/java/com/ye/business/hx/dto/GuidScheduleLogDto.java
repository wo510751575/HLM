...
public class GuidScheduleLogDto implements Serializable { 
	...
	public String toString() {
		return "GuidScheduleLogDto [code=" + code + ", memberNoGuid=" + memberNoGuid + ", memberNameGuid="
				...
				+ ", aptFlag=" + aptFlag + ", createId=" + createId + ", createDate=" + createDate + ", workDateStr="
				+ workDateStr + "]";
	}
