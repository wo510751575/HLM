...
public class BillPaymentDto implements Serializable {
	...
	public String toString() {
		return "BillPaymentDto [code=" + code + ", payNo=" + payNo + ", patientNo=" + patientNo + ", patientName="
				+ patientName + ", medicalNo=" + medicalNo + ", billCode=" + billCode + ", operateCode=" + operateCode
				+ ", shopNo=" + shopNo + ", shopName=" + shopName + ", merchantNo=" + merchantNo + ", merchantName="
				+ merchantName + ", payType=" + payType + ", payTypeName=" + payTypeName + ", payRemark=" + payRemark
				+ ", payAmount=" + payAmount + ", payTime=" + payTime + ", recieverNo=" + recieverNo + ", recieverName="
				+ recieverName + ", bizType=" + bizType + ", status=" + status + ", receivableAmt=" + receivableAmt
				+ ", debtAmt=" + debtAmt + ", payMode=" + payMode + ", billPayAmount=" + billPayAmount + ", updateId="
				+ updateId + ", updateDate=" + updateDate + ", createId=" + createId + ", createDate=" + createDate
				+ ", remark=" + remark + ", remark1=" + remark1 + ", remark2=" + remark2 + ", remark3=" + remark3
				+ ", remark4=" + remark4 + "]";
	}
