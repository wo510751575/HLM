...
public class ImEmoji {
    ...
    public void setEmojiUrl(String emojiUrl) {
        this.emojiUrl = emojiUrl == null ? null : emojiUrl.trim();
    }
    ...
    public String toString() {
        ...
        builder.append("ImEmoji [code=").append(code);
        builder.append(",packageCode=").append(packageCode); 
        builder.append(",emojiName=").append(emojiName); 
        builder.append(",emojiUrl=").append(emojiUrl); 
