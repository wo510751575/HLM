...
public class FindWxSmallProgramPageReturn extends PageParamEntity implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 1232408181244315717L; 
    /**
     * CODE .
     */
    private String code;
    ...
    public String toString() {
        ...
        builder.append("FindWxSmallProgramPageReturn [code=").append(code);
