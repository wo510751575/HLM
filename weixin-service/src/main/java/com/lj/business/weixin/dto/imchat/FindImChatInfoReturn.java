...
public class FindImChatInfoReturn implements Serializable { 

	private static final long serialVersionUID = 4739409982742753313L;
	...
	public String toString() {
		...
		builder.append("FindImChatInfoReturn [code=");
		builder.append(code);
