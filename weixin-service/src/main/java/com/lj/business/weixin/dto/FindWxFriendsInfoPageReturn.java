...
public class FindWxFriendsInfoPageReturn implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -1025152978893750799L; 
	/**
     * CODE .
     */
    private String code;
     ...
     * 朋友圈评论列表
     */
    private List<FindWxCommentInfoPageReturn> commentInfos;
    /**
     * 朋友圈点赞列表
     */
    private List<Map<String, String>> likeInfos;
    /**
     * 会员头像
     */
	...
	/**
	 * @return the commentInfos
	 */
	public List<FindWxCommentInfoPageReturn> getCommentInfos() {
		return commentInfos;
	}

	/**
	 * @param commentInfos the commentInfos to set
	 */
	public void setCommentInfos(List<FindWxCommentInfoPageReturn> commentInfos) {
		this.commentInfos = commentInfos;
	}

	/**
	 * @return the likeInfos
	 */
	public List<Map<String, String>> getLikeInfos() {
		return likeInfos;
	}

	/**
	 * @param likeInfos the likeInfos to set
	 */
	public void setLikeInfos(List<Map<String, String>> likeInfos) {
