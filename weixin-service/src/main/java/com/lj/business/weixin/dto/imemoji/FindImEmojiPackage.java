...
public class FindImEmojiPackage implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 5617136251027423008L; 
	...
	public String toString() {
		...
		builder.append("FindImEmojiPackage [code=");
		builder.append(code);
