...
public class UpdateImEmojiPackage implements Serializable { 

    /**
	 * 
	 */
	private static final long serialVersionUID = 5813769656558816554L;
	...
	public String toString() {
		...
		builder.append("UpdateImEmojiPackage [code=");
		builder.append(code);
