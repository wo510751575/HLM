...
public class FindImEmojiPageReturn implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 4126928983872187380L; 
	...
	public String toString() {
		...
		builder.append("FindImEmojiPageReturn [code=");
		builder.append(code);
