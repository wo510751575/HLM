...
public class FindImEmojiPackagePageReturn implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 5863068837643115999L; 
	...
	public String toString() {
		...
		builder.append("FindImEmojiPackagePageReturn [code=");
		builder.append(code);
