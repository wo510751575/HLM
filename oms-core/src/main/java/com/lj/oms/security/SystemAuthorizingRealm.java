...
public class SystemAuthorizingRealm extends AuthorizingRealm {
	...
	protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken authcToken) {
		...
		if (user != null) {
			...
			logger.debug("token.getType():"+token.getType());
			//token登录
			if( UsernamePasswordToken.LOGIN_TYPE_TOKEN.equals(token.getType())){
				String pwd=SystemService.entryptPassword(user.getId());
