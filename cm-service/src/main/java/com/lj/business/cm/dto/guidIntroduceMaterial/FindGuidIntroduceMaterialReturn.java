...
public class FindGuidIntroduceMaterialReturn implements Serializable { 

    /**
	 * 
	 */
	private static final long serialVersionUID = -4885014005057395092L;
	...
	public String toString() {
		...
		builder.append("FindGuidIntroduceMaterialReturn [code=");
		builder.append(code);
