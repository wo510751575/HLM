...
public class FindMaterialTypePageReturn implements Serializable {
	...
	public String toString() {
		return "FindMaterialTypePageReturn [code=" + code + ", merchantNo=" + merchantNo + ", memberNoGm=" + memberNoGm
				+ ", memberNameGm=" + memberNameGm + ", typeName=" + typeName + ", createId=" + createId + ", remark="
				+ remark + ", createDate=" + createDate + ", typeCount=" + typeCount + ", imgAddr=" + imgAddr
				+ ", customerAttentionRate=" + customerAttentionRate + ", linkUrl=" + linkUrl + ", officeName="
				+ officeName + "]";
	}
