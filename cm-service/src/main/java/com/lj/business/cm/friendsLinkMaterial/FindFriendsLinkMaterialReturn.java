...
public class FindFriendsLinkMaterialReturn implements Serializable { 

    /**
	 * 
	 */
	private static final long serialVersionUID = 5099014445769621112L;
	...
	public String toString() {
		...
		builder.append("FindFriendsLinkMaterialReturn [code=");
		builder.append(code);
