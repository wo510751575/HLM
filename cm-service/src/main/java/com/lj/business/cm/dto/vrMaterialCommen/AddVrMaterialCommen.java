...
public class AddVrMaterialCommen implements Serializable { 

    /**
	 * 
	 */
	private static final long serialVersionUID = 6707774764683197344L;
	...
	public String toString() {
		...
		builder.append("AddVrMaterialCommen [code=");
		builder.append(code);
