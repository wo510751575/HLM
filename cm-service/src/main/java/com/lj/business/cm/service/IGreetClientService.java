...
public interface IGreetClientService {
     ...
     * 
     *
     * 方法说明：添加问候客户表信息（没有添加积分）
     *
     * @param addGreetClient
     * @return
     * @throws TsfaServiceException
     *
     * @author 罗书明 CreateDate: 2017年9月25日
     *
     */
	public AddGreetClientReturn addGreetClients(AddGreetClient addGreetClient) throws TsfaServiceException;
