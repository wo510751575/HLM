...
public class FindGuidIntroduceMaterialPageReturn implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -3367419683569244091L; 
    ...
    private String h5Address = "/oms-web/a/business/materialIntroduce/viewH5";
	...
	public String toString() {
		...
		builder.append("FindGuidIntroduceMaterialPageReturn [code=");
		builder.append(code);
