...
public class FindVrMaterialTypeCategoryList implements Serializable { 
    ...
    private  FindVrMaterialTypeCategoryList[] list;
    
    

	public FindVrMaterialTypeCategoryList[] getList() {
		return list;
	}

	public void setList(FindVrMaterialTypeCategoryList[] list) {
		this.list = list;
	}
