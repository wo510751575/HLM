...
public class FindFriendsVideoMaterialPageReturn implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 3453386816396865952L; 
    ...
    public String toString() {
        ...
        builder.append("FindFriendsVideoMaterialPageReturn [code=").append(code);
