...
public class UpdateVrMaterialType implements Serializable { 

    /**
	 * 
	 */
	private static final long serialVersionUID = 4092463806696937378L;
    ...
    private List<UpdateVrMaterialType> categoryList;
	...
	public List<UpdateVrMaterialType> getCategoryList() {
		return categoryList;
	}

	public void setCategoryList(List<UpdateVrMaterialType> categoryList) {
