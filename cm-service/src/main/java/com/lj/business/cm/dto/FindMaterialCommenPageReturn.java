...
public class FindMaterialCommenPageReturn implements Serializable {
	...
	public String toString() {
		return "FindMaterialCommenPageReturn [code=" + code + ", materialTypeCode=" + materialTypeCode
				+ ", materialTypeName=" + materialTypeName + ", title=" + title + ", content=" + content + ", imgAddr="
				+ imgAddr + ", respondNum=" + respondNum + ", createId=" + createId + ", merchantNo=" + merchantNo
				+ ", merchantName=" + merchantName + ", dimensionSt=" + dimensionSt + ", linkUrl=" + linkUrl
				+ ", urlH5=" + urlH5 + ", shopType=" + shopType + ", tempId=" + tempId + ", brief=" + brief
				+ ", officeName=" + officeName + ", createDate=" + createDate + "]";
	}
