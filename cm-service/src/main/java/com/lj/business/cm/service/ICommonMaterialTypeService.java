 ...
 */
public interface ICommonMaterialTypeService {
	 ...
	 *
	 * @author 罗书明 CreateDate: 2017年6月21日
	 * @param findMaterialTypeReturn 
	 */
	public UpdateMaterialTypeReturn updateMaterialType(UpdateMaterialType updateMaterialType, FindMaterialTypeReturn findMaterialTypeReturn)throws TsfaServiceException;
	 ...
	 *
	 */
	public List<FindMaterialTypePageReturn> findMaterialTypes(FindMaterialTypePage findMaterialTypePage) throws TsfaServiceException;
	 ...
	 *
	 */
	public List<FindMaterialTypesAppReturn> findMaterialTypesApp(FindMaterialTypesApp findMaterialTypesApp) throws TsfaServiceException;
	 ...
	 *
	 */
	public int incrementTypeCountByPrimaryKey(String code, Integer increment) throws TsfaServiceException;
	 ...
	 *
	 */
	public int decrementTypeCountByPrimaryKey(String code, Integer decrement) throws TsfaServiceException;
	 ...
	 *
	 */
	public List<FindMaterialTypePageReturn> findMateriaTypeList(FindMaterialTypePage findMaterialTypePage)throws TsfaServiceException;
