...
public class FindVrMaterialTypePageReturn implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -7909128191563795478L; 
	...
	public String toString() {
		return "FindVrMaterialTypePageReturn [code=" + code + ", merchantNo="
