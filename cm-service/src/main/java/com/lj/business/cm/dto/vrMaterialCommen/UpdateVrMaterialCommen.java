...
public class UpdateVrMaterialCommen implements Serializable { 

    /**
	 * 
	 */
	private static final long serialVersionUID = 3839996254173178882L;
	...
	public String toString() {
		...
		builder.append("UpdateVrMaterialCommen [code=");
		builder.append(code);
