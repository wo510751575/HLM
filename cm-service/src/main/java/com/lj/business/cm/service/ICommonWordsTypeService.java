 ...
 */
public interface ICommonWordsTypeService {
	 ...
	 *
	 */
	public int hasTypeName(String merchantNo,String typeName) throws TsfaServiceException;
	 ...
	 *
	 */
	public int hasSeq(String merchantNo,Integer seq) throws TsfaServiceException;
