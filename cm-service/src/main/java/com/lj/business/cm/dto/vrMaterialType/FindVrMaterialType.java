...
public class FindVrMaterialType implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -7060492940054823369L; 
	...
	public String toString() {
		...
		builder.append("FindVrMaterialType [code=");
		builder.append(code);
		...
		builder.append(imgAddr);
		builder.append(", customerAttentionRate=");
		builder.append(customerAttentionRate);
		builder.append(", materialDimension=");
		builder.append(materialDimension);
