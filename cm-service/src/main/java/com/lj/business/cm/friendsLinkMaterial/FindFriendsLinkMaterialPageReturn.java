...
public class FindFriendsLinkMaterialPageReturn implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -3685629810034808333L; 
	/**
     * CODE .
     */
    private String code;
	...
	public String toString() {
		...
		builder.append("FindFriendsLinkMaterialPageReturn [code=");
		builder.append(code);
