...
public class FindVrMaterialCommenCategoryPageReturn implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -6756721187143300050L; 
	...
	public String toString() {
		return "FindVrMaterialCommenCategoryPageReturn [code=" + code
