...
public class AddFriendsLinkMaterial implements Serializable { 

    /**
	 * 
	 */
	private static final long serialVersionUID = -6476249295616734379L;
	...
	public String toString() {
		...
		builder.append("AddFriendsLinkMaterial [code=");
		builder.append(code);
