...
public class AddGuidIntroduceMaterial implements Serializable { 

    /**
	 * 
	 */
	private static final long serialVersionUID = -5550326030937459379L;
	...
	public String toString() {
		...
		builder.append("AddGuidIntroduceMaterial [code=");
		builder.append(code);
