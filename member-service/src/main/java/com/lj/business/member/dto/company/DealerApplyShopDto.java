...
public class DealerApplyShopDto implements Serializable {

    /**
     * 
     */
    private static final long serialVersionUID = -5391115494469543927L;
	...
	public void setShopManagerWxNo(String shopManagerWxNo) {
		this.shopManagerWxNo = shopManagerWxNo;
	}
	...
	public String toString() {
		...
		builder.append("DealerApplyShopDto [shopNoMerchant=");
		...
		builder.append(shopManagerMobile);
		builder.append(", shopManagerWxNo=");
		builder.append(shopManagerWxNo);
		builder.append("]");
