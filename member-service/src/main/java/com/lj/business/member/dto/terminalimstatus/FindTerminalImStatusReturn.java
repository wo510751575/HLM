...
public class FindTerminalImStatusReturn implements Serializable { 

    /**
	 * 
	 */
	private static final long serialVersionUID = -6918198212489454041L;
	...
	public String toString() {
		...
		builder.append("FindTerminalImStatusReturn [code=");
		builder.append(code);
