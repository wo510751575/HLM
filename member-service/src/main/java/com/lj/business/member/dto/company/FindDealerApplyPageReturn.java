...
public class FindDealerApplyPageReturn implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 2416249922689307215L; 
    ...
    public String toString() {
        ...
        builder.append("FindDealerApplyPageReturn [code=");
        builder.append(code);
