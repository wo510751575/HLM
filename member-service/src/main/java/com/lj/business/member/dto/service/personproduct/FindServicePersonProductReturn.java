...
/**
 * The Class FindPhoneInfoReturn.
 */
public class FindServicePersonProductReturn implements Serializable { 


	/**
	 * 
	 */
	private static final long serialVersionUID = 4299523670117843512L;
	...
	public String toString() {
		...
		builder.append("FindServicePersonProductReturn [code=");
		builder.append(code);
