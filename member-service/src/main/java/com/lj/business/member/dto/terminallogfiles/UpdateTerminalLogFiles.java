...
public class UpdateTerminalLogFiles implements Serializable { 

    /**
	 * 
	 */
	private static final long serialVersionUID = 1750975390159922652L;
	...
	public String toString() {
		...
		builder.append("UpdateTerminalLogFiles [code=");
		builder.append(code);
		builder.append(", imei=");
		builder.append(imei);
