...
/**
 * The Class AddPhoneInfo.
 */
public class AddPhoneInfo implements Serializable { 


    /** The Constant serialVersionUID. */
	private static final long serialVersionUID = -4627552775271628352L;
	...
	public String toString() {
		...
		builder.append("AddPhoneInfo [memberNoMerchant=")
				.append(memberNoMerchant)
				.append(", status=")
				.append(status).append(", imei=").append(imei)
				.append(", memberNo=").append(memberNo).append(", memberName=")
				.append(memberName).append(", memberType=").append(memberType)
