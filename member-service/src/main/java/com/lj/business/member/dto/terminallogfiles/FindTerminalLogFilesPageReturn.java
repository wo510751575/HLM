...
public class FindTerminalLogFilesPageReturn implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 6202287077943019964L; 
	/**
     * CODE .
     */
    private String code;
	...
	public String toString() {
		...
		builder.append("FindTerminalLogFilesPageReturn [code=");
		builder.append(code);
		builder.append(", imei=");
		builder.append(imei);
