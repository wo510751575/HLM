 ...
 */
public class FindServicePersonPageReturn implements Serializable { 


	/**
	 * 
	 */
	private static final long serialVersionUID = -220260839715578825L;
	...
	public String toString() {
		...
		builder.append("FindServicePersonPageReturn [code=");
		builder.append(code);
