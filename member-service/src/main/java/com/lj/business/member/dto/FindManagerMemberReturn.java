...
/**
 * The Class FindManagerMemberReturn.
 */
public class FindManagerMemberReturn implements Serializable { 

	/** The Constant serialVersionUID. */
	private static final long serialVersionUID = 3031249239031605843L;
   ...
   /** 微信号. */
	...
	public String toString() {
		...
		builder.append("FindManagerMemberReturn [code=").append(code)
				...
				.append(age).append(", pwd=").append(pwd)
				...
				.append(", countryWx=").append(countryWx).append(", noWx=")
				.append(noWx).append(", provinceWx=").append(provinceWx)
				...
				.append(updateDate).append(", areaCode=").append(areaCode)
