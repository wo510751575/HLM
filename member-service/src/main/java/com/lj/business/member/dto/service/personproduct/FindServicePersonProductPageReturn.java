 ...
 */
public class FindServicePersonProductPageReturn implements Serializable { 


	/**
	 * 
	 */
	private static final long serialVersionUID = -4725530531792712772L;
	...
	public String toString() {
		...
		builder.append("FindServicePersonProductPageReturn [code=");
		builder.append(code);
