...
public class ShopTerminal implements Serializable{
    /**
     * CODE .
     */
    private String code;
	...
	public String toString() {
		return "ShopTerminal [code=" + code + ", terminalCode=" + terminalCode + ", merchantNo=" + merchantNo
				+ ", merchantName=" + merchantName + ", noWx=" + noWx + ", usernameWx=" + usernameWx + ", wxNickname="
				...
				+ ", headurl=" + headurl + ", nickname=" + nickname + ", shopName=" + shopName + "]";
	}
