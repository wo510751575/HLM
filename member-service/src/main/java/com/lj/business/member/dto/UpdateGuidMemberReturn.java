...
/**
 * The Class UpdateGuidMemberReturn.
 */
public class UpdateGuidMemberReturn implements Serializable {

	/** The Constant serialVersionUID. */
	private static final long serialVersionUID = 5919547274827402422L; 
	/**
     * CODE .
     */
    private String code;
	...
	public String toString() {
		...
		builder.append("GuidMemberReturnDto [code=").append(code)
				...
				.append(headAddress).append(", gender=").append(gender)
