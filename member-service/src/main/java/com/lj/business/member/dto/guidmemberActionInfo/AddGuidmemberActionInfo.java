...
/**
 * The Class AddGuidmemberActionInfo.
 */
public class AddGuidmemberActionInfo implements Serializable { 

    /** The Constant serialVersionUID. */
	private static final long serialVersionUID = 7430689052641901340L;
	...
	public String toString() {
		...
		builder.append("AddGuidmemberActionInfo [code=");
		builder.append(code);
