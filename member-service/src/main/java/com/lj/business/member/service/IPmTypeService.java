...
public interface IPmTypeService {
	 ...
	 *
	 */
	public List<FindPmTypeIndexReturn> findUnContactMemberPmTypes(FindUnContactPmType findUnContactPmType)throws TsfaServiceException;
     ...
     * @return
     */
    int findCountByUngroup(FindPmTypeIndex findPmTypeIndex) throws TsfaServiceException;
}
