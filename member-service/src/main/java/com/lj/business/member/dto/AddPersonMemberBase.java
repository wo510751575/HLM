...
public class AddPersonMemberBase implements Serializable { 
	 ...
	 *
	 * @param brandCompare the brand compare
	 */
	 ...
	 * Sets the 预计购买时间 .
	 *
	 * @param expectPurchaseTime the new 预计购买时间 
	 */
	...
	public String toString() {
		...
		builder.append("AddPersonMemberBase [code=").append(code)
				...
				.append(", job=").append(job).append(", address=")
				.append(address).append(", age=").append(age).append(", sex=")
				.append(sex).append(", nameAuthFlag=").append(nameAuthFlag)
				...
				.append(", nickNameWx=").append(nickNameWx).append(", cityWx=")
				...
				.append(", urgencyPm=").append(urgencyPm).append(", spruceUp=")
				.append(spruceUp).append(", memberNoGm=").append(memberNoGm)
				.append(", memberNameGm=").append(memberNameGm)
				.append(", pmTypeCode=").append(pmTypeCode)
				.append(", pmTypeName=").append(pmTypeName)
				.append(", bomName=").append(bomName).append(", houses=")
				.append(houses).append(", merchantNo=").append(merchantNo)
				.append(", merchantName=").append(merchantName)
				.append(", imei=").append(imei).append(", noWx=").append(noWx)
				.append(", noWxAlias=").append(noWxAlias)
				...
				.append(", cityCode=").append(cityCode).append(", birthday=")
				.append(birthday).append(", clientSpecial=")
				.append(clientSpecial).append(", brandCompare=")
				.append(brandCompare).append(", expectPurchaseTime=")
				.append(expectPurchaseTime).append(", expTime=")
				.append(expTime).append(", constellation=")
				.append(constellation).append(", consumeFrequency=")
				.append(consumeFrequency).append(", remark=").append(remark)
				.append(", jobName=").append(jobName).append(", noWw=").append(noWw).append("]");
