...
/**
 * The Class FindManagerMemberPageReturn.
 */
public class FindManagerMemberPageReturn implements Serializable {

	/** The Constant serialVersionUID. */
	private static final long serialVersionUID = -9038636376124228185L;
	...
	public String toString() {
		...
		builder.append("FindManagerMemberPageReturn [code=").append(code)
				...
				.append(", noWx=").append(noWx).append(", shopNoMerchant=")
