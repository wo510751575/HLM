...
public class FindChatRoomPageReturn implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -5380481130949061608L; 
    ...
    private List<FindChatRoomMemberReturn> memberList;
	 ...
	 */
	public List<FindChatRoomMemberReturn> getMemberList() {
		return memberList;
	}
	 ...
	 */
	public void setMemberList(List<FindChatRoomMemberReturn> memberList) {
		this.memberList = memberList;
	}

	@Override
	public String toString() {
		return "FindChatRoomPageReturn [code=" + code + ", noWxZk=" + noWxZk + ", chatRoomName=" + chatRoomName
				...
				+ ", memberNameGm=" + memberNameGm + ", memberList=" + memberList + "]";
	}
