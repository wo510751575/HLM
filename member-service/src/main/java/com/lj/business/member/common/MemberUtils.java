...
//			throw new TsfaServiceException(ErrorCode.MBR_MEMBER_STATUS_IS_CANCEL, "会员[" + memberNo + "]已注销");
		case LEAVE:
			throw new TsfaServiceException(ErrorCode.MBR_MEMBER_STATUS_IS_LEAVE, "会员[" + memberNo + "]已离职");
		}
	}
...
//			throw new TsfaServiceException(ErrorCode.MBR_MERCHANT_MEMBER_STATUS_IS_CANCEL, "商户会员[" + merchantNo + "]已注销");
		case LEAVE:
			throw new TsfaServiceException(ErrorCode.MBR_MEMBER_STATUS_IS_LEAVE, "会员[" + merchantNo + "]已离职");
		}
	}
