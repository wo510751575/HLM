...
public class FindTerminalLogFilesReturn implements Serializable { 

    /**
	 * 
	 */
	private static final long serialVersionUID = -8049084954643433914L;
	...
	public String toString() {
		...
		builder.append("FindTerminalLogFilesReturn [code=");
		builder.append(code);
		builder.append(", imei=");
		builder.append(imei);
