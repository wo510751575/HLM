...
/**
 * The Class UpdatePmType.
 */
public class UpdatePmType implements Serializable { 

	 
	 /** Generate cron. */
	private static final long serialVersionUID = 2462836663952991239L;
	 /**
     * CODE .
     */
    private String code;
 ...
 其他：OTHER .
     ...
     * 旧的，修改前的typecode
     */
    private String oldPmTypeName;
    
    
	public String getOldPmTypeName() {
		return oldPmTypeName;
	}

	public void setOldPmTypeName(String oldPmTypeName) {
		this.oldPmTypeName = oldPmTypeName;
	}
	...
	public String toString() {
		...
		builder.append("UpdatePmType [code=");
		builder.append(code);
		...
		builder.append(remark4);
		builder.append(", freValue=");
		builder.append(freValue);
		builder.append(", oldPmTypeName=");
		builder.append(oldPmTypeName);
		builder.append("]");
