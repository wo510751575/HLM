...
public class AddServiceProduct implements Serializable { 
     ...
     /**
	     ...
	     * @throws 
	     */
	private static final long serialVersionUID = -4750526783144173965L;
	...
	public String toString() {
		...
		builder.append("AddServiceProduct [code=");
		builder.append(code);
