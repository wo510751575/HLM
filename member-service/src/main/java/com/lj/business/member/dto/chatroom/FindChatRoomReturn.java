...
public class FindChatRoomReturn implements Serializable { 

    /**
	 * 
	 */
	private static final long serialVersionUID = -1107657557813633837L;
	...
	public String toString() {
		return "FindChatRoomReturn [code=" + code + ", noWxZk=" + noWxZk + ", chatRoomName=" + chatRoomName
