 ...
 */
public class FindPersonMemberReturn implements Serializable { 
	...
	public String toString() {
		return "FindPersonMemberReturn [code=" + code + ", memberNo=" + memberNo + ", memberName=" + memberName
				+ ", memberNoGm=" + memberNoGm + ", memberNameGm=" + memberNameGm + ", headAddress=" + headAddress
				+ ", merchantNo=" + merchantNo + ", merchantName=" + merchantName + ", spruceUp=" + spruceUp
				+ ", houses=" + houses + ", keepEye=" + keepEye + ", urgencyPm=" + urgencyPm + ", bomCode=" + bomCode
				+ ", bomName=" + bomName + ", createId=" + createId + ", createDate=" + createDate + ", updateId="
				+ updateId + ", updateDate=" + updateDate + ", remark4=" + remark4 + ", remark3=" + remark3
				+ ", remark2=" + remark2 + ", remark=" + remark + ", scanAddress=" + scanAddress + ", latitude="
				+ latitude + ", longitude=" + longitude + ", brandCompare=" + brandCompare + ", clientSpecial="
				+ clientSpecial + ", consumeFrequency=" + consumeFrequency + ", followTimes=" + followTimes
				+ ", keepTimes=" + keepTimes + ", orderTimes=" + orderTimes + ", pmTypeCode=" + pmTypeCode
				+ ", pmTypeName=" + pmTypeName + ", nickNameRemarkWx=" + nickNameRemarkWx + "]";
	}
