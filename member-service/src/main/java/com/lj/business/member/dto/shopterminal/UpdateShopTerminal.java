...
public class UpdateShopTerminal implements Serializable { 

    /**
	 * 
	 */
	private static final long serialVersionUID = -962218384840155029L;
	...
	public String toString() {
		return "UpdateShopTerminal [code=" + code + ", terminalCode=" + terminalCode + ", merchantNo=" + merchantNo
				+ ", merchantName=" + merchantName + ", shopName=" + shopName + ", noWx=" + noWx + ", wxNickname="
				+ wxNickname + ", headAddress=" + headAddress + ", qcord=" + qcord + ", sex=" + sex + ", wxVersionCode="
				+ wxVersionCode + ", wxVersionName=" + wxVersionName + ", wxBalance=" + wxBalance + ", wxPwd=" + wxPwd
				+ ", signTime=" + signTime + ", workKey=" + workKey + ", imei=" + imei + ", status=" + status
				+ ", versionName=" + versionName + ", versionCode=" + versionCode + ", uploadFriendsFlag="
				+ uploadFriendsFlag + ", createId=" + createId + ", createDate=" + createDate + ", remark=" + remark
				+ ", remark2=" + remark2 + ", remark3=" + remark3 + ", remark4=" + remark4 + ", alias=" + alias
