...
public class FindPersonMemberBaseReturn implements Serializable {
	...
	/**
	 * 会员状态 NORMAL正常 CANCEL注销 FREEZE冻结 .
	 */
	 ...
	 * Sets the 昵称备注_本地.
	 *
	 * @param nickNameRemarkLocal the new 昵称备注_本地
	 */
	 ...
	 *
	 * @param ratioClientInfo
	 *            the ratioClientInfo to set
	 */
	...
	public String toString() {
		...
		builder.append("FindPersonMemberBaseReturn [code=").append(code)
				...
				.append(noWx).append(", noWxAlias=").append(noWxAlias)
				...
				.append(houses).append(", ratioClientInfo=")
				.append(ratioClientInfo).append(", birthday=").append(birthday)
