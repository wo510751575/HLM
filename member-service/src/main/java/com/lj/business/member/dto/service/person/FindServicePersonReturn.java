 ...
 */
public class FindServicePersonReturn implements Serializable { 


	/**
	 * 
	 */
	private static final long serialVersionUID = 3296808281547764415L;
	...
	public String toString() {
		...
		builder.append("FindServicePersonReturn [code=");
		builder.append(code);
