...
public class UpdateServicePersonProductReturn implements Serializable {
	 ...
	 /**
	     ...
	     * @throws 
	     */
	private static final long serialVersionUID = -6099565918205520448L; 
	/**
     * CODE .
     */
    private String code;
	...
	public String toString() {
		...
		builder.append("UpdateServicePersonProductReturn [code=");
		builder.append(code);
