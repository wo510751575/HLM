...
public class FindForecastNameReturn implements Serializable { 

    /**
	 * 
	 */
	private static final long serialVersionUID = -3053753356342046182L;
	...
	public String toString() {
		...
		builder.append("FindForecastNameReturn [code=");
		builder.append(code);
