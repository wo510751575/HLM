...
/**
 * The Class FindGuidMemberIntegralReturn.
 */
public class FindGuidMemberIntegralReturn implements Serializable { 

    /** The Constant serialVersionUID. */
	private static final long serialVersionUID = -7155994093036762471L;
	...
	public String toString() {
		...
		builder.append("FindGuidMemberIntegralReturn [code=").append(code)
				...
				.append(codeName).append(", integralType=")
				.append(integralType).append(", integralScore=")
				.append(integralScore).append(", daySt=").append(daySt)
