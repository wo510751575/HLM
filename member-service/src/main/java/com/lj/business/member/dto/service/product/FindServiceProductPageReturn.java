...
public class FindServiceProductPageReturn implements Serializable {
	 ...
	 /**
	     ...
	     * @throws 
	     */
	private static final long serialVersionUID = -4975609681591468119L; 
	...
	public String toString() {
		...
		builder.append("FindServiceProductPageReturn [code=");
		builder.append(code);
