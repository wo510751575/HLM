...
public class AddChatRoom implements Serializable { 

    /**
	 * 
	 */
	private static final long serialVersionUID = 6969044594231778059L;
	...
	public String toString() {
		return "AddChatRoom [code=" + code + ", noWxZk=" + noWxZk + ", chatRoomName=" + chatRoomName + ", roomNickName="
				+ roomNickName + ", roomOwner=" + roomOwner + ", headUrl=" + headUrl + ", status=" + status
				+ ", merchantNo=" + merchantNo + ", merchantName=" + merchantName + ", version=" + version
