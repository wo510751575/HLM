...
/**
 * The Class FindPmTypePageReturn.
 */
public class FindPmTypePageReturn implements Serializable {

	
	 /** Generate cron. */
	private static final long serialVersionUID = -8837603435142812460L; 
	 /**
     * CODE .
     */
    private String code;
 ...
 其他：OTHER .
    ...
    public String toString() {
        ...
        builder.append("FindPmTypePageReturn [code=");
        builder.append(code);
