 ...
 */
public class PersonMemberBase implements java.io.Serializable{
	
	private static final long serialVersionUID = 8974674687146294043L;
    /**
     * CODE .
     */
    private String code;
	...
	public String toString() {
		...
		builder.append("PersonMemberBase [code=");
		builder.append(code);
