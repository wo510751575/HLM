...
public class FindGuidCardPageReturn implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 4090721217399219621L; 
	...
	public String toString() {
		...
		builder.append("FindGuidCardPageReturn [code=");
		builder.append(code);
