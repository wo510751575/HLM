...
public class UpdateServiceProductReturn implements Serializable {
	 ...
	 /**
	     ...
	     * @throws 
	     */
	private static final long serialVersionUID = 3931503642417015849L; 
	...
	public String toString() {
		...
		builder.append("UpdateServiceProductReturn [code=");
		builder.append(code);
