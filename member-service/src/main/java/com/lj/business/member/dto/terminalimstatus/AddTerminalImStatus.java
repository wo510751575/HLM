...
public class AddTerminalImStatus implements Serializable { 

    /**
	 * 
	 */
	private static final long serialVersionUID = -832697625206406602L;
	...
	public String toString() {
		...
		builder.append("AddTerminalImStatus [code=");
		builder.append(code);
