...
public class FindServiceProductReturn implements Serializable { 
     ...
     /**
	     ...
	     * @throws 
	     */
	private static final long serialVersionUID = 5706171204942362103L;
	...
	public String toString() {
		...
		builder.append("FindServiceProductReturn [code=");
		builder.append(code);
