...
public class FindChatRoomMemberReturn implements Serializable { 

    /**
	 * 
	 */
	private static final long serialVersionUID = -6174235767077122L;
	/**
     * CODE .
     */
    private String code;
	...
	public String toString() {
		...
		builder.append("FindChatRoomMemberReturn [code=");
		builder.append(code);
