...
public class AddFriendsTaskDetailDto implements Serializable { 
	...
	public String toString() {
		return "AddFriendsTaskDetailDto [code=" + code + ", taskCode=" + taskCode + ", phone=" + phone + ", username="
				+ username + ", sendMessage=" + sendMessage + ", createDate=" + createDate + ", executeDate="
				+ executeDate + ", addfriendsDate=" + addfriendsDate + ", callbackDate=" + callbackDate + ", noWx="
				+ noWx + ", noWxGm=" + noWxGm + ", status=" + status + ", detail=" + detail + ", merchantNo="
				+ merchantNo + ", merchantName=" + merchantName + ", codes=" + codes + "]";
	}
