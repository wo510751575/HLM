...
public class AddChatRoomMember implements Serializable { 

    /**
	 * 
	 */
	private static final long serialVersionUID = 9086616188884214236L;
	/**
     * CODE .
     */
    private String code;
	...
	public String toString() {
		...
		builder.append("AddChatRoomMember [code=");
		builder.append(code);
