 ...
 */
public class UpdateServicePersonProduct implements Serializable { 

	/**
	 * 
	 */
	private static final long serialVersionUID = -5430922742773884404L;
	...
	public String toString() {
		...
		builder.append("UpdateServicePersonProduct [code=");
		builder.append(code);
