...
/**
 * The Class FindIntegralSetReturn.
 */
public class FindIntegralSetReturn implements Serializable { 

    /** The Constant serialVersionUID. */
	private static final long serialVersionUID = 4935923262450792742L;
	...
	public String toString() {
		...
		builder.append("FindIntegralSetReturn [code=").append(code)
