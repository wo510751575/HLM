...
/**
 * The Class FindGuidmemberActionInfoReturn.
 */
public class FindGuidmemberActionInfoReturn implements Serializable { 

    /** The Constant serialVersionUID. */
	private static final long serialVersionUID = 3410041007939569092L;
	...
	public String toString() {
		...
		builder.append("FindGuidmemberActionInfoReturn [code=");
		builder.append(code);
