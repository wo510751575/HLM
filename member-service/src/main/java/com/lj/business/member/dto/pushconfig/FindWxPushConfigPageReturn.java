...
public class FindWxPushConfigPageReturn implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 5791915856252204961L; 
    /**
     * CODE .
     */
    private String code;
    ...
    public String toString() {
        ...
        builder.append("FindWxPushConfigPageReturn [code=").append(code);
