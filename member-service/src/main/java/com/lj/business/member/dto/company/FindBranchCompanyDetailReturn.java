...
public class FindBranchCompanyDetailReturn implements Serializable {

    /**
     * 
     */
    private static final long serialVersionUID = 4062202109407101179L;
     ...
     * 分公司账号列表 .
     */
    private List<FindCompanyBankAccountReturn> accountList;
    ...
    public List<FindCompanyBankAccountReturn> getAccountList() {
        return accountList;
    }

    public void setAccountList(List<FindCompanyBankAccountReturn> accountList) {
	...
	public String toString() {
		...
		builder.append("FindBranchCompanyDetailReturn [code=");
		builder.append(code);
