...
/**
 * The Class FindMemberLoginInfoReturn.
 */
public class FindMemberLoginInfoReturn implements Serializable { 

    /** The Constant serialVersionUID. */
	private static final long serialVersionUID = -9292846457371026L;
	...
	public String toString() {
		...
		builder.append("FindMemberLoginInfoReturn [code=");
		builder.append(code);
