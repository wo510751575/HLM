...
public class AddForecastName implements Serializable { 

    /**
	 * 
	 */
	private static final long serialVersionUID = -5748488189455217107L;
	...
	public String toString() {
		...
		builder.append("AddForecastName [code=");
		builder.append(code);
