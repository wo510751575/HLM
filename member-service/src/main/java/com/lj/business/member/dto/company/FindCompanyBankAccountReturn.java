...
public class FindCompanyBankAccountReturn implements Serializable { 

    /**
	 * 
	 */
	private static final long serialVersionUID = -8716440931890241813L;
	...
	public String toString() {
		...
		builder.append("FindCompanyBankAccountReturn [code=");
		builder.append(code);
