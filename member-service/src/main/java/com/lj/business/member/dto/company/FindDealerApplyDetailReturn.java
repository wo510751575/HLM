...
public class FindDealerApplyDetailReturn implements Serializable {

    /**
     * 
     */
    private static final long serialVersionUID = 3940672035596615405L;
     ...
     * 附件是否是图片类型
     */
    private Boolean attachmentIsImg;
     ...
     * 终端列表
     */
    private List<DealerApplyShopDto> shopList;
    ...
    public List<DealerApplyShopDto> getShopList() {
        return shopList;
    }

    public void setShopList(List<DealerApplyShopDto> shopList) {
    ...
    public Boolean getAttachmentIsImg() {
        return attachmentIsImg;
    }

    public void setAttachmentIsImg(Boolean attachmentIsImg) {
        this.attachmentIsImg = attachmentIsImg;
    }

	@Override
	public String toString() {
		StringBuilder builder = new StringBuilder();
		builder.append("FindDealerApplyDetailReturn [code=");
		builder.append(code);
		...
		builder.append(attachment);
		builder.append(", attachmentIsImg=");
		builder.append(attachmentIsImg);
