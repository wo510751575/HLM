...
public class FindServiceProduct implements Serializable {
	 ...
	 /**
	     ...
	     * @throws 
	     */
	private static final long serialVersionUID = -6861512822658756674L; 
	...
	public String toString() {
		...
		builder.append("FindServiceProduct [code=");
		builder.append(code);
