...
/**
 * The Class AddGuidMemberDto.
 */
public class AddGuidMemberDto implements Serializable{

	 /** Generate cron. */
	private static final long serialVersionUID = 1344549341962118745L;
	/**
     * CODE .
     */
    private String code;
	...
	public String toString() {
		...
		builder.append("AddGuidMemberDto [code=").append(code)
