...
/**
 * The Class FindPersonMemberBasePageReturn.
 */
public class FindPersonMemberBasePageReturn implements Serializable {
	...
	public String toString() {
		...
		builder.append("FindPersonMemberBasePageReturn [code=").append(code)
