...
public class FindGuidCardCustomerPageReturn implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -1958368807484095780L; 
	...
	public String toString() {
		return "AddGuidCardCustomer [code=" + code + ", guidCardCode="
