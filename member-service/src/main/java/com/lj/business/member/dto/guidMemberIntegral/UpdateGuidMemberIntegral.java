...
/**
 * The Class UpdateGuidMemberIntegral.
 */
public class UpdateGuidMemberIntegral implements Serializable { 

    /** The Constant serialVersionUID. */
	private static final long serialVersionUID = -6972611137480476346L;
	...
	public String toString() {
		...
		builder.append("UpdateGuidMemberIntegral [code=").append(code)
