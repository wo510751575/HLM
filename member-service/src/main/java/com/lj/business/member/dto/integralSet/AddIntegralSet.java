...
/**
 * The Class AddIntegralSet.
 */
public class AddIntegralSet implements Serializable { 

    /** The Constant serialVersionUID. */
	private static final long serialVersionUID = 7024830537009250606L;
	...
	public String toString() {
		...
		builder.append("AddIntegralSet [code=").append(code)
